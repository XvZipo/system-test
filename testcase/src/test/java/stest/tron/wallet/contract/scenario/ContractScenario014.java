...
@Slf4j
public class ContractScenario014 extends AbstractGrpcDualFullAndSolidityTest {
  ...
  public void testClearAbi() {
    ...
    Assert.assertEquals("", ByteArray.toHexString(infoById.get().getResMessage().toByteArray()));
