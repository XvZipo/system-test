...
@Slf4j
public class ContractScenario015 extends AbstractGrpcDualFullAndSolidityTest {
  ...
  public void testTriggerConstantContract() {
    ...
    logger.info(":" + ByteArray.toStr(transactionExtention.getResult().getMessage().toByteArray()));
