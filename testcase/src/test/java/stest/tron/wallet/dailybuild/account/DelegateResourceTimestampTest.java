  ...
  public void beforeClass() throws Exception {
    ...
    Assert.assertTrue(
        PublicMethed.freezeBalanceV1ForReceiver(
            frozen1Address, frozenAmount, 0, 0, receiver1Address, frozen1Key, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethed.freezeBalanceV1ForReceiver(
    ...
    Assert.assertTrue(
        PublicMethed.freezeBalanceV1ForReceiver(
            frozen1Address, frozenAmount, 0, 0, receiver3Address, frozen1Key, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethed.freezeBalanceV1ForReceiver(
            receiver1Address, frozenAmount, 0, 0, frozen1Address, receiver1Key, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethed.freezeBalanceV1ForReceiver(
            receiver2Address, frozenAmount, 0, 0, frozen1Address, receiver2Key, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethed.freezeBalanceV1ForReceiver(
            receiver3Address, frozenAmount, 0, 0, frozen1Address, receiver3Key, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
  }
