...
public class FreezeWeightDeflationTest {
  ...
  public void beforeClass() throws Exception {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            frozen1Address, sendAmount, foundationAddress, foundationKey, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.sendcoin(
            frozen2Address, sendAmount, foundationAddress, foundationKey, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.sendcoin(
            receiver1Address, 1L, foundationAddress, foundationKey, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.sendcoin(
            receiver2Address, 1L, foundationAddress, foundationKey, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethed.freezeBalanceV1ForReceiver(
            foundationAddress,
            frozenAmount * 8,
            0,
            0,
  ...
  public void test01FreezeNetCauseWeightDeflationTest() {
    final Long beforeNetWeight =
        PublicMethed.getAccountResource(frozen1Address, blockingStubFull).getTotalNetWeight();
    final Long beforeEnergyWeight =
        PublicMethed.getAccountResource(frozen1Address, blockingStubFull).getTotalEnergyWeight();
  ...
  public void test02FreezeEnergyCauseWeightDeflationTest() {
    ...
    Assert.assertTrue(
        PublicMethed.freezeBalanceGetEnergy(
            frozen1Address, frozenAmount, 0, 1, frozen1Key, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Long afterEnergyWeight =
        PublicMethed.getAccountResource(frozen1Address, blockingStubFull).getTotalEnergyWeight();
    ...
    Assert.assertTrue(
        PublicMethed.unFreezeBalance(frozen1Address, frozen1Key, 1, null, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    afterEnergyWeight =
        PublicMethed.getAccountResource(frozen1Address, blockingStubFull).getTotalEnergyWeight();
    Assert.assertTrue(afterEnergyWeight - beforeEnergyWeight == 0);
  ...
  public void test03DelegateEnergyToTwoReceiverCauseWeightDeflationTest() {
    ...
    Assert.assertTrue(
        PublicMethed.freezeBalance(
            frozen1Address, frozenAmount * 4, 0, frozen1Key, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.freezeBalanceGetEnergy(
            frozen1Address, frozenAmount * 5, 0, 1, frozen1Key, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.freezeBalance(
            frozen2Address, frozenAmount * 6, 0, frozen2Key, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.freezeBalanceGetEnergy(
            frozen2Address, frozenAmount * 7, 0, 1, frozen2Key, blockingStubFull));
    ...
    Assert.assertTrue(
        PublicMethed.freezeBalanceV1ForReceiver(
            frozen1Address, frozenAmount, 0, 1, receiver1Address, frozen1Key, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.freezeBalanceV1ForReceiver(
            frozen1Address, frozenAmount, 0, 1, receiver2Address, frozen1Key, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Long afterEnergyWeight =
        PublicMethed.getAccountResource(frozen1Address, blockingStubFull).getTotalEnergyWeight();
    ...
    Assert.assertTrue(
        PublicMethed.unFreezeBalance(
            frozen1Address, frozen1Key, 1, receiver1Address, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.unFreezeBalance(
            frozen1Address, frozen1Key, 1, receiver2Address, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    afterEnergyWeight =
        PublicMethed.getAccountResource(frozen1Address, blockingStubFull).getTotalEnergyWeight();
    Assert.assertTrue(afterEnergyWeight - beforeEnergyWeight == 0);
  ...
  @Test(
      enabled = true,
      description = "Two account delegate net to one receiver cause weight deflation test")
  public void test04TwoAccountDelegateNetToOneReceiverCauseWeightDeflationTest() {
    ...
    Assert.assertTrue(
        PublicMethed.freezeBalanceV1ForReceiver(
            frozen1Address, frozenAmount, 0, 0, receiver2Address, frozen1Key, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.freezeBalanceV1ForReceiver(
            frozen2Address, frozenAmount, 0, 0, receiver2Address, frozen2Key, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Long afterNetWeight =
        PublicMethed.getAccountResource(frozen1Address, blockingStubFull).getTotalNetWeight();
    Assert.assertTrue(afterNetWeight - beforeNetWeight == 3);
    ...
    Assert.assertTrue(
        PublicMethed.unFreezeBalance(
            frozen1Address, frozen1Key, 0, receiver2Address, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.unFreezeBalance(
            frozen2Address, frozen2Key, 0, receiver2Address, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    afterNetWeight =
        PublicMethed.getAccountResource(frozen1Address, blockingStubFull).getTotalNetWeight();
    Assert.assertTrue(afterNetWeight - beforeNetWeight == 0);
