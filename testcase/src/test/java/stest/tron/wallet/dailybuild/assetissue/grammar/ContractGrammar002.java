...
public class ContractGrammar002 {
  ...
  public void test1Grammar007() {
    ...
    String code1 = retMap1.get("byteCode").toString() + "0000000000000000000000" + initParmes;
    ...
    Optional<TransactionInfo> infoById1 =
        PublicMethed.getTransactionInfoById(txid1, blockingStubFull1);
    ...
    Optional<TransactionInfo> infoById2 =
        PublicMethed.getTransactionInfoById(txid2, blockingStubFull1);
  ...
  public void test2Grammar008() {
    ...
    Assert.assertEquals(
        returnString1, "6d69616f77000000000000000000000000000000000000000000000000000000");
  }
  ...
  public void shutdown() throws InterruptedException {
    PublicMethed.freedResource(
        grammarAddress2, testKeyForGrammarAddress2, testNetAccountAddress, blockingStubFull);
    if (channelFull != null) {
