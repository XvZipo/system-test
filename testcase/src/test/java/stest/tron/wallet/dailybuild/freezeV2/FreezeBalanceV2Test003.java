...
public class FreezeBalanceV2Test003 {
  ...
  public void beforeClass() throws Exception {
    ...
    Assert.assertTrue(
        PublicMethed.getTransactionById(txid, blockingStubFull).get().getSignatureCount() == 1);
  }

  @Test(enabled = true, description = "MutiSign for freeze balance V2")
  public void test01MutiSignForFreezeBalanceV2() {
    Assert.assertTrue(
        PublicMethedForMutiSign.freezeBalanceV2WithPermissionId(
            ownerAddress, freezeBalance, 0, 2, ownerKey, blockingStubFull, permissionKeyString));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Transaction transaction =
        PublicMethed.getTransactionById(PublicMethedForMutiSign.freezeV2Txid, blockingStubFull)
            .get();
    logger.info("FreezeBalanceV2 txid:" + PublicMethedForMutiSign.freezeV2Txid);
    Assert.assertTrue(transaction.getSignatureCount() == 2);
    Assert.assertEquals(
        transaction.getRawData().getContract(0).getType(), ContractType.FreezeBalanceV2Contract);
    Assert.assertTrue(
  ...
  public void test02MutiSignForDelegateResource() {
    Assert.assertTrue(
        PublicMethedForMutiSign.delegateResourceWithPermissionId(
            ownerAddress,
            delegateBalance,
            0,
            receiverAddress,
    ...
    Assert.assertTrue(transaction.getSignatureCount() == 2);
    Assert.assertEquals(
        transaction.getRawData().getContract(0).getType(), ContractType.DelegateResourceContract);
    Assert.assertTrue(
        PublicMethed.getTransactionInfoById(PublicMethedForMutiSign.freezeV2Txid, blockingStubFull)
                .get()
                .getFee()
  ...
  public void test03MutiSignForUnDelegateResource() {
    Assert.assertTrue(
        PublicMethedForMutiSign.unDelegateResourceWithPermissionId(
            ownerAddress,
            delegateBalance,
            0,
            receiverAddress,
    ...
    Assert.assertTrue(transaction.getSignatureCount() == 2);
    Assert.assertEquals(
        transaction.getRawData().getContract(0).getType(), ContractType.UnDelegateResourceContract);
    Assert.assertTrue(
        PublicMethed.getTransactionInfoById(PublicMethedForMutiSign.freezeV2Txid, blockingStubFull)
                .get()
                .getFee()
  ...
  public void test04MutiSignForUnFreezeBalanceV2() {
    Assert.assertTrue(
        PublicMethedForMutiSign.unFreezeBalanceV2WithPermissionId(
            ownerAddress, delegateBalance, 0, 2, ownerKey, blockingStubFull, permissionKeyString));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Transaction transaction =
        PublicMethed.getTransactionById(PublicMethedForMutiSign.freezeV2Txid, blockingStubFull)
            .get();
    Assert.assertTrue(transaction.getSignatureCount() == 2);
    Assert.assertEquals(
        transaction.getRawData().getContract(0).getType(), ContractType.UnfreezeBalanceV2Contract);
    Assert.assertTrue(
        PublicMethed.getTransactionInfoById(PublicMethedForMutiSign.freezeV2Txid, blockingStubFull)
                .get()
                .getFee()
  ...
  public void test05WithdrawExpireUnfreezeBalance() {
    ...
    if (System.currentTimeMillis() - 2000L < account.getUnfrozenV2(0).getUnfreezeExpireTime()) {
      Assert.assertFalse(
          PublicMethedForMutiSign.withdrawExpireUnfreezeBalanceWithPermissionId(
              ownerAddress, 2, ownerKey, blockingStubFull, permissionKeyString));
  ...
  public void test06MultiSignForCancelUnfreeze() {
    ...
    Assert.assertTrue(
        PublicMethedForMutiSign.unFreezeBalanceV2WithPermissionId(
            ownerAddress, 1, 0, 2, ownerKey, blockingStubFull, permissionKeyString));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    ...
    li.add(0);
    Assert.assertTrue(
        PublicMethedForMutiSign.cancelAllUnfreezeWithPermissionId(
            ownerAddress, 2, blockingStubFull, permissionKeyString));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    TransactionInfo info =
        PublicMethed.getTransactionInfoById(
                PublicMethedForMutiSign.cancelUnfreezeTxId, blockingStubFull)
            .get();
