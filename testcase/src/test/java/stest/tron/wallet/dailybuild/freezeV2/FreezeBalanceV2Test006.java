...
public class FreezeBalanceV2Test006 {
  ...
  public void beforeClass() throws Exception {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            receiverAddress, 1L, foundationAddress, foundationKey, blockingStubFull));
  ...
  public void test01DelegateResourceLockValueIsTrueTest() throws Exception {
    ...
    DelegatedResourceList delegatedResourceList =
        PublicMethed.getDelegatedResource(frozenBandwidthAddress, receiverAddress, blockingStubFull)
            .get();
    PublicMethed.waitSolidityNodeSynFullNodeData(blockingStubFull, blockingStubFullSolidity);
    // query solidity
    DelegatedResourceList delegatedResourceListSolidity =
        PublicMethed.getDelegatedResourceV2Solidity(
                frozenBandwidthAddress, receiverAddress, blockingStubFullSolidity)
            .get();
    ...
    DelegatedResourceList delegatedResourceListPbft =
        PublicMethed.getDelegatedResourceV2Solidity(
                frozenBandwidthAddress, receiverAddress, blockingStubPbft)
            .get();
  ...
  @Test(
      enabled = true,
      description = "delegateResource bandwidth lock = true and lockPeriod is a non-zero value")
  public void test02DelegateResourceBandWidthLockPeriodValueIsNonZeroTest() {
    ...
    PublicMethed.sendcoin(
        fromAddress, sendAmount, foundationAddress, foundationKey, blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
  ...
  public void test03unDelegateEnergyAfterLockPeriod() {
    ...
    logger.info("delegatedResourceList: " + delegatedResourceList.get());
    Assert.assertEquals(expireTimeForEnergy - currentTime, lockPeriod * 3 * 1000L);
  ...
  @Test(
      enabled = true,
      description = "lock = false an lockPeriod = non-zero value, lockPeriod is invalid")
  public void test04InvalidLockPeriodValueWhenLockIsFalse() {
    ...
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    PublicMethed.delegateResourceV2Lock(
        fromAddress, delegateBalance, 1, false, 50L, receiverAddress, fromKey, blockingStubFull);
  ...
  public void test05LockPeriodIsZero() {
    ...
    String txId =
        PublicMethed.delegateResourceV2LockAndGetTxId(
            fromAddress, delegateBalance, 1, true, 0L, receiverAddress, fromKey, blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    TransactionInfo info = PublicMethed.getTransactionInfoById(txId, blockingStubFull).get();
    long lastBlockNumber = info.getBlockNumber() - 1;
    Long lockStartTime =
        PublicMethed.getBlock2(lastBlockNumber, blockingStubFull)
            .getBlockHeader()
            .getRawData()
            .getTimestamp();
    Optional<DelegatedResourceList> delegatedResourceList =
  ...
  public void test06LockPeriodBoundaryTest() {
    ...
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    GrpcAPI.TransactionExtention ext =
        PublicMethed.delegateResourceV2AndGetTransactionExtention(
            fromAddress,
            delegateBalance,
            1,
            true,
  ...
  @Test(
      enabled = true,
      description = "Period less than current expire time and bigger than expire time")
  ...
  public void test08DelegateLockTwiceInSameBlock() {
    ...
    String txId2 =
        PublicMethed.delegateResourceV2LockAndGetTxId(
            ...
            blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Transaction transaction1 = PublicMethed.getTransactionById(txId1, blockingStubFull).get();
    Transaction transaction2 = PublicMethed.getTransactionById(txId2, blockingStubFull).get();
    Assert.assertNotNull(transaction1);
    Assert.assertNotNull(transaction2);
    Assert.assertEquals(transaction1.getRet(0).getContractRet().name(), "SUCCESS");
    Assert.assertEquals(transaction2.getRet(0).getContractRet().name(), "SUCCESS");
  }
