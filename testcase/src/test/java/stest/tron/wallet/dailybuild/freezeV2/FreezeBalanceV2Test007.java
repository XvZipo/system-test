...
public class FreezeBalanceV2Test007 {
  ...
  public void beforeClass() throws Exception {
    ...
    Assert.assertTrue(
        PublicMethed.freezeBalanceV2(testAddress001, 20000000L, 0, testKey001, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.freezeBalanceV2(testAddress001, 20000000L, 1, testKey001, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
  }
  ...
  public void test01CancelAllUnfreezeNet() {
    GrpcAPI.AccountResourceMessage resource1 =
    ...
    Assert.assertTrue(
        PublicMethed.unFreezeBalanceV2(testAddress001, testKey001, 1000000L, 0, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    GrpcAPI.AccountResourceMessage resource2 =
        PublicMethed.getAccountResource(testAddress001, blockingStubFull);
    ...
    String txid =
        PublicMethed.cancelAllUnFreezeBalanceV2AndGetTxid(
    ...
    GrpcAPI.AccountResourceMessage resource3 =
        PublicMethed.getAccountResource(testAddress001, blockingStubFull);
  ...
  public void test02CancelAllUnfreezeEnergy() {
    ...
    Assert.assertTrue(
        PublicMethed.unFreezeBalanceV2(testAddress001, testKey001, 1000000L, 1, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    ...
    for (int i = 0; i < 32; i++) {
      Assert.assertTrue(
          PublicMethed.unFreezeBalanceV2(
              testAddress001, testKey001, i + 1, i % 2, blockingStubFull));
    }
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    GrpcAPI.AccountResourceMessage resource1 =
        PublicMethed.getAccountResource(testAddress001, blockingStubFull);
  ...
  public void test05CancelAllUnfreeze() {
    ...
    for (int i = 0; i < 2; i++) {
      Assert.assertTrue(
          PublicMethed.unFreezeBalanceV2(
              testAddress001, testKey001, 1000000L * (i + 1), 0, blockingStubFull));
      Assert.assertTrue(
          PublicMethed.unFreezeBalanceV2(
              testAddress001, testKey001, 1000000L * (i + 1), 1, blockingStubFull));
      try {
        Thread.sleep(30000);
    ...
    Protocol.TransactionInfo info1 =
        PublicMethed.getTransactionInfoByIdFromSolidity(txid, blockingStubFullSolidity).get();
    Protocol.TransactionInfo info2 =
        PublicMethed.getTransactionInfoByIdFromSolidity(txid, blockingStubPbft).get();
    ...
    Assert.assertEquals(
        balanceBeforeCancel - info.getReceipt().getNetFee() + info.getWithdrawExpireAmount(),
        balanceAfterCancel);
  ...
  public void test06VoteAfterCancelAllUnfreeze() {
    ...
    Assert.assertTrue(
        PublicMethed.voteWitness(testAddress001, testKey001, voteMap, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Protocol.Account account1 = PublicMethed.queryAccount(testAddress001, blockingStubFull);
  ...
  @Test(
      enabled = true,
      description = "all freeze vote, then unfreeze some , then cancel unfreeze. expect vote desc")
  public void test07UnfreezeWithVotedAndCancelAllUnfreeze() {
    Assert.assertTrue(
        PublicMethed.unFreezeBalanceV2(testAddress001, testKey001, 19000000L, 0, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Protocol.Account account1 = PublicMethed.queryAccount(testAddress001, blockingStubFull);
    ...
    Assert.assertEquals(
        info.getCancelUnfreezeV2AmountMap().get("BANDWIDTH").longValue(), 19000000L);
    Assert.assertEquals(info.getWithdrawExpireAmount(), 0);
    Protocol.Account account2 = PublicMethed.queryAccount(testAddress001, blockingStubFull);
    long balance2 = account2.getBalance();
