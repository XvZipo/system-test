...
public class HttpShieldTrc20Token003 extends AbstractZenTrc20HttpNodes012 {
  ...
  public void test01TransferTypeWith1V1ByHttp() {
    ...
    shieldedReceives =
        getHttpShieldedReceivesJsonArray(
            ...
            getRcm(httpnode));
    response =
        createShieldContractParametersForTransfer(
  ...
  @Test(
      enabled = true,
      description = "Query is shielded trc20 contract note spent on " + "solidity by http")
  public void test05QueryIsShieldedTrc20ContractNoteSpentByHttp() {
    HttpMethed.waitToProduceOneBlockFromSolidity(httpnode, httpSolidityNode);
    Assert.assertTrue(
        isShieldedTrc20ContractNoteSpentOnSolidity(
            httpSolidityNode, shieldAccountInfo1, account1IvkNoteTxs.getJSONObject(2)));
    Assert.assertTrue(
        isShieldedTrc20ContractNoteSpentOnSolidity(
            httpSolidityNode, shieldAccountInfo1, account1IvkNoteTxs.getJSONObject(3)));
  }
