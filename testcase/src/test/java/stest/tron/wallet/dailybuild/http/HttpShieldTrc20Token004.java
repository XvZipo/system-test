...
import stest.tron.wallet.common.client.utils.AbstractZenTrc20HttpNodes0124;
import stest.tron.wallet.common.client.utils.HttpMethed;

@Slf4j
public class HttpShieldTrc20Token004 extends AbstractZenTrc20HttpNodes0124 {
  ...
  private Long account2Receive2V2Amount =
      publicFromAmount + account2Receive1V2Amount - account1Receive2V2Amount;
  ...
  public void prepareForTransfer() {
    ...
    shieldedReceives =
        getHttpShieldedReceivesJsonArray(
            shieldedReceives,
            publicFromAmount,
            shieldAccountInfo1.getString("payment_address"),
            getRcm(httpnode));
    HttpMethed.waitToProduceOneBlock(httpnode);
    response =
        createShieldContractParameters(
            httpnode, publicFromAmount, shieldAccountInfo1, shieldedReceives);
  ...
  public void test01TransferTypeWith1V1WithoutAskByHttp() {
    ...
    shieldSpends.clear();
    shieldSpends =
        createAndSetShieldedSpends(httpnode, shieldSpends, account1IvkNoteTxs.getJSONObject(0));
    HttpMethed.waitToProduceOneBlock(httpnode);
    shieldedReceives.clear();
    shieldedReceives =
        getHttpShieldedReceivesJsonArray(
            shieldedReceives,
            publicFromAmount,
            shieldAccountInfo2.getString("payment_address"),
            getRcm(httpnode));
    response =
        createShieldContractParametersWithoutAskForTransfer(
            httpnode, shieldAccountInfo1, shieldSpends, shieldedReceives);
    ...
    JSONObject spendAuthSig =
        createSpendAuthSig(
            ...
            account1IvkNoteTxs.getJSONObject(0).getJSONObject("note").getString("rcm"));
    ...
    response =
        getTriggerInputForShieldedTrc20Contract(
            httpnode, shieldedTrc20Parameters, spendAuthSigArray);
    responseContent = HttpMethed.parseResponseContent(response);
    HttpMethed.printJsonContent(responseContent);
    ...
    HttpMethed.printJsonContent(responseContent);
    Assert.assertTrue(
        responseContent.getJSONObject("receipt").getLong("energy_usage_total") > 300000L);
  ...
  public void test02TransferTypeWith1V2WithoutAskByHttp() {
    ...
    Assert.assertTrue(
        isShieldedTrc20ContractNoteSpent(
            httpnode, shieldAccountInfo1, account1IvkNoteTxs.getJSONObject(0)));
    Assert.assertFalse(
        isShieldedTrc20ContractNoteSpent(
            httpnode, shieldAccountInfo1, account1IvkNoteTxs.getJSONObject(1)));
    shieldSpends.clear();
    shieldSpends =
        createAndSetShieldedSpends(httpnode, shieldSpends, account1IvkNoteTxs.getJSONObject(1));

    shieldedReceives.clear();
    shieldedReceives =
        getHttpShieldedReceivesJsonArray(
            shieldedReceives,
            account1Receive1V2Amount,
            shieldAccountInfo1.getString("payment_address"),
            getRcm(httpnode));
    shieldedReceives =
        getHttpShieldedReceivesJsonArray(
            shieldedReceives,
            account2Receive1V2Amount,
            shieldAccountInfo2.getString("payment_address"),
            getRcm(httpnode));
    response =
        createShieldContractParametersWithoutAskForTransfer(
    ...
    JSONObject shieldedTrc20Parameters = HttpMethed.parseResponseContent(response);
    HttpMethed.printJsonContent(shieldedTrc20Parameters);
    JSONObject spendAuthSig1 =
        createSpendAuthSig(
            httpnode,
            shieldAccountInfo1,
            shieldedTrc20Parameters.getString("message_hash"),
            account1IvkNoteTxs.getJSONObject(1).getJSONObject("note").getString("rcm"));
  ...
  public void test03TransferTypeWith2V2WithoutAskByHttp() {
    ...
    Assert.assertFalse(
        isShieldedTrc20ContractNoteSpent(
            httpnode, shieldAccountInfo2, account2IvkNoteTxs.getJSONObject(0)));
    Assert.assertFalse(
        isShieldedTrc20ContractNoteSpent(
            httpnode, shieldAccountInfo2, account2IvkNoteTxs.getJSONObject(1)));
    shieldSpends.clear();
    shieldSpends =
        createAndSetShieldedSpends(httpnode, shieldSpends, account2IvkNoteTxs.getJSONObject(0));
    shieldSpends =
        createAndSetShieldedSpends(httpnode, shieldSpends, account2IvkNoteTxs.getJSONObject(1));
    shieldedReceives.clear();
    shieldedReceives =
        getHttpShieldedReceivesJsonArray(
            shieldedReceives,
    ...
    shieldedReceives =
        getHttpShieldedReceivesJsonArray(
            shieldedReceives,
            account2Receive2V2Amount,
            shieldAccountInfo2.getString("payment_address"),
            getRcm(httpnode));
    response =
        createShieldContractParametersWithoutAskForTransfer(
            httpnode, shieldAccountInfo2, shieldSpends, shieldedReceives);
    JSONObject shieldedTrc20Parameters = HttpMethed.parseResponseContent(response);
    ...
    JSONObject spendAuthSig1 =
        createSpendAuthSig(
            ...
            shieldAccountInfo2,
            shieldedTrc20Parameters.getString("message_hash"),
            account2IvkNoteTxs.getJSONObject(0).getJSONObject("note").getString("rcm"));
    HttpMethed.printJsonContent(spendAuthSig1);

    JSONObject spendAuthSig2 =
        createSpendAuthSig(
            httpnode,
            shieldAccountInfo2,
            shieldedTrc20Parameters.getString("message_hash"),
            account2IvkNoteTxs.getJSONObject(1).getJSONObject("note").getString("rcm"));
    JSONArray spendAuthSigArray = new JSONArray();
    spendAuthSigArray.add(spendAuthSig1);
    spendAuthSigArray.add(spendAuthSig2);
  ...
  public void test04TransferTypeWith2V1WithoutAskByHttp() {
    ...
    Assert.assertFalse(
        isShieldedTrc20ContractNoteSpent(
            httpnode, shieldAccountInfo1, account1IvkNoteTxs.getJSONObject(2)));
    Assert.assertFalse(
        isShieldedTrc20ContractNoteSpent(
            httpnode, shieldAccountInfo1, account1IvkNoteTxs.getJSONObject(3)));
    shieldSpends.clear();
    shieldSpends =
        createAndSetShieldedSpends(httpnode, shieldSpends, account1IvkNoteTxs.getJSONObject(2));
    shieldSpends =
        createAndSetShieldedSpends(httpnode, shieldSpends, account1IvkNoteTxs.getJSONObject(3));
    Long account1Receive2V1Amount =
        account1IvkNoteTxs.getJSONObject(2).getJSONObject("note").getLong("value")
            + account1IvkNoteTxs.getJSONObject(3).getJSONObject("note").getLong("value");
    shieldedReceives.clear();
    shieldedReceives =
        getHttpShieldedReceivesJsonArray(
            shieldedReceives,
            account1Receive2V1Amount,
            shieldAccountInfo1.getString("payment_address"),
            getRcm(httpnode));
    response =
        createShieldContractParametersWithoutAskForTransfer(
    ...
    JSONObject spendAuthSig1 =
        createSpendAuthSig(
            ...
            shieldAccountInfo1,
            shieldedTrc20Parameters.getString("message_hash"),
            account1IvkNoteTxs.getJSONObject(2).getJSONObject("note").getString("rcm"));
    HttpMethed.printJsonContent(spendAuthSig1);
    ...
    JSONObject spendAuthSig2 =
        createSpendAuthSig(
            ...
            shieldAccountInfo1,
            shieldedTrc20Parameters.getString("message_hash"),
            account1IvkNoteTxs.getJSONObject(3).getJSONObject("note").getString("rcm"));
    ...
    Assert.assertTrue(
        isShieldedTrc20ContractNoteSpent(
            httpnode, shieldAccountInfo1, account1IvkNoteTxs.getJSONObject(2)));
    Assert.assertTrue(
        isShieldedTrc20ContractNoteSpentOnPbft(
            httpPbftNode, shieldAccountInfo1, account1IvkNoteTxs.getJSONObject(2)));
    Assert.assertTrue(
        isShieldedTrc20ContractNoteSpent(
            httpnode, shieldAccountInfo1, account1IvkNoteTxs.getJSONObject(3)));
    Assert.assertTrue(
        isShieldedTrc20ContractNoteSpentOnPbft(
            httpPbftNode, shieldAccountInfo1, account1IvkNoteTxs.getJSONObject(3)));
  }
  ...
  public void test05ScanNoteByIvkAndOvkOnSOlidityAndPbftByHttp() {
    ...
    account1IvkNoteTxs = scanShieldTrc20NoteByIvk(httpnode, shieldAccountInfo1);
    JSONArray account1IvkNoteTxsOnSolidity =
        scanShieldTrc20NoteByIvkOnSolidity(httpSolidityNode, shieldAccountInfo1);
    Assert.assertEquals(account1IvkNoteTxs, account1IvkNoteTxsOnSolidity);
    JSONArray account1IvkNoteTxsOnPbft =
        scanShieldTrc20NoteByIvkOnPbft(httpPbftNode, shieldAccountInfo1);
    Assert.assertEquals(account1IvkNoteTxs, account1IvkNoteTxsOnPbft);

    account1OvkNoteTxs = scanShieldTrc20NoteByOvk(httpnode, shieldAccountInfo1);
    JSONArray account1OvkNoteTxsOnSolidity =
        scanShieldTrc20NoteByOvkOnSolidity(httpSolidityNode, shieldAccountInfo1);
    Assert.assertEquals(account1OvkNoteTxs, account1OvkNoteTxsOnSolidity);
    JSONArray account1OvkNoteTxsOnPbft =
        scanShieldTrc20NoteByOvkOnPbft(httpPbftNode, shieldAccountInfo1);
    Assert.assertEquals(account1OvkNoteTxs, account1OvkNoteTxsOnPbft);

    account2IvkNoteTxs = scanShieldTrc20NoteByIvk(httpnode, shieldAccountInfo2);
    JSONArray account2IvkNoteTxsOnSolidity =
        scanShieldTrc20NoteByIvkOnSolidity(httpSolidityNode, shieldAccountInfo2);
    Assert.assertEquals(account2IvkNoteTxs, account2IvkNoteTxsOnSolidity);
    JSONArray account2IvkNoteTxsOnPbft =
        scanShieldTrc20NoteByIvkOnPbft(httpPbftNode, shieldAccountInfo2);
    Assert.assertEquals(account2IvkNoteTxs, account2IvkNoteTxsOnPbft);

    account2OvkNoteTxs = scanShieldTrc20NoteByOvk(httpnode, shieldAccountInfo2);
    JSONArray account2OvkNoteTxsOnSolidity =
        scanShieldTrc20NoteByOvkOnSolidity(httpSolidityNode, shieldAccountInfo2);
    Assert.assertEquals(account2OvkNoteTxs, account2OvkNoteTxsOnSolidity);
    JSONArray account2OvkNoteTxsOnPbft =
        scanShieldTrc20NoteByOvkOnPbft(httpPbftNode, shieldAccountInfo2);
