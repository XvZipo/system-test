...
@Slf4j
public class HttpTestAccount002 extends AbstractHttpEndpoints124 {
  ...
  public void test001FreezeBalanceForBandwidth() {
    ...
    response =
        HttpMethed.freezeBalance(
            httpnode, freezeBalanceAddress, frozenBalance, 0, 0, freezeBalanceKey);
    Assert.assertTrue(HttpMethed.verificationResult(response));
    HttpMethed.waitToProduceOneBlock(httpnode);
  ...
  public void test002UnFreezeBalanceForBandwidth() {
    ...
    if (HttpMethed.getProposalValue(httpnode, ProposalEnum.GetUnfreezeDelayDays.getProposalName())
        > 0) {
      response =
          HttpMethed.unFreezeBalanceV2(
              httpnode, freezeBalanceAddress, frozenBalance, 0, freezeBalanceKey);
    } else {
      response =
  ...
  public void test003FreezeBalanceForEnergy() {
    ...
    response =
        HttpMethed.freezeBalance(
            httpnode, freezeBalanceAddress, frozenBalance, 0, 1, freezeBalanceKey);
    Assert.assertTrue(HttpMethed.verificationResult(response));
    HttpMethed.waitToProduceOneBlock(httpnode);
    afterBalance = HttpMethed.getBalance(httpnode, freezeBalanceAddress);
    Assert.assertTrue(berforeBalance - afterBalance == frozenBalance);
  ...
  public void test004UnFreezeBalanceForEnergy() {
    ...
    if (HttpMethed.getProposalValue(httpnode, ProposalEnum.GetUnfreezeDelayDays.getProposalName())
      ...
      response =
          HttpMethed.unFreezeBalanceV2(
              httpnode, freezeBalanceAddress, frozenBalance, 1, freezeBalanceKey);
    } else {
      response =
          HttpMethed.unFreezeBalance(
              httpnode, freezeBalanceAddress, frozenBalance, 1, freezeBalanceKey);
  ...
  public void test005FreezeBalanceOfBandwidthForOthers() {
    response =
        HttpMethed.sendCoin(httpnode, fromAddress, receiverResourceAddress, amount, testKey002);
    Assert.assertTrue(HttpMethed.verificationResult(response));
    HttpMethed.waitToProduceOneBlock(httpnode);
    berforeBalance = HttpMethed.getBalance(httpnode, freezeBalanceAddress);
  ...
  public void test006GetDelegatedResource() {
    ...
    response =
        HttpMethed.getDelegatedResource(httpnode, freezeBalanceAddress, receiverResourceAddress);
    ...
    Assert.assertEquals(
        jsonArray.getJSONObject(0).getString("from"), ByteArray.toHexString(freezeBalanceAddress));
    Assert.assertEquals(
        jsonArray.getJSONObject(0).getString("to"), ByteArray.toHexString(receiverResourceAddress));
    Assert.assertEquals(
        jsonArray.getJSONObject(0).getLong("frozen_balance_for_bandwidth"), frozenBalance);
  }
  ...
  public void test007GetDelegatedResourceFromSolidity() {
    ...
    response =
        HttpMethed.getDelegatedResourceFromSolidity(
  ...
  public void test008GetDelegatedResourceFromPbft() {
    ...
    HttpMethed.waitToProduceOneBlockFromPbft(httpnode, httpPbftNode);
    response =
        HttpMethed.getDelegatedResourceFromPbft(
            httpPbftNode, freezeBalanceAddress, receiverResourceAddress);
    responseContent = HttpMethed.parseResponseContent(response);
    HttpMethed.printJsonContent(responseContent);
    JSONArray jsonArray = JSONArray.parseArray(responseContent.get("delegatedResource").toString());
    Assert.assertTrue(jsonArray.size() >= 1);
  ...
  public void test010GetDelegatedResourceAccountIndexFromSolidity() {
    ...
    response =
        HttpMethed.getDelegatedResourceAccountIndexFromSolidity(
            httpSoliditynode, freezeBalanceAddress);
    responseContent = HttpMethed.parseResponseContent(response);
    HttpMethed.printJsonContent(responseContent);
    Assert.assertFalse(responseContent.get("toAccounts").toString().isEmpty());
    String toAddress = responseContent.getJSONArray("toAccounts").get(0).toString();
  ...
  public void test011GetDelegatedResourceAccountIndexFromPbft() {
    ...
    response =
        HttpMethed.getDelegatedResourceAccountIndexFromPbft(httpPbftNode, freezeBalanceAddress);
    responseContent = HttpMethed.parseResponseContent(response);
    HttpMethed.printJsonContent(responseContent);
    Assert.assertFalse(responseContent.get("toAccounts").toString().isEmpty());
    String toAddress = responseContent.getJSONArray("toAccounts").get(0).toString();
  ...
  public void test013FreezeBalanceOfEnergyForOthers() {
    ...
    response =
        HttpMethed.freezeBalance(
            httpnode, fromAddress, 1000000000L, 0, 0, freezeBalanceAddress, testKey002);
    HttpMethed.waitToProduceOneBlock(httpnode);
    berforeBalance = HttpMethed.getBalance(httpnode, freezeBalanceAddress);
  ...
  public void test015FreezeTronPower() {
    ...
    if (HttpMethed.getProposalValue(
            httpnode, ProposalEnum.GetAllowNewResourceModel.getProposalName())
        == 1) {
      return;
    }
    HttpMethed.waitToProduceOneBlock(httpnode);
  ...
  public void shutdown() throws InterruptedException {
    response =
        HttpMethed.unFreezeBalance(
            httpnode, fromAddress, frozenBalance, 0, freezeBalanceAddress, testKey002);
    Assert.assertTrue(HttpMethed.verificationResult(response));
