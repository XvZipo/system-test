...
/** */
@Slf4j
public class HttpTestFreezeV2001 extends AbstractHttpEndpoints124 {
  ...
  public void beforeClass() {
    ...
    response =
        HttpMethed.sendCoin(httpnode, fromAddress, freezeBandwidthAddress, amount, testKey002);
    response = HttpMethed.sendCoin(httpnode, fromAddress, freezeEnergyAddress, amount, testKey002);
    response = HttpMethed.sendCoin(httpnode, fromAddress, receiverResourceAddress, 1L, testKey002);
  ...
  public void test001FreezeBalanceV2ForBandwidth() {
    ...
    response =
        HttpMethed.freezeBalanceV2(
            httpnode, freezeBandwidthAddress, frozenBalance, 0, null, freezeBandwidthKey);
    Assert.assertTrue(HttpMethed.verificationResult(response));
    HttpMethed.waitToProduceOneBlock(httpnode);
  ...
  public void test002UnFreezeBalanceV2ForBandwidth() {
    ...
    response =
        HttpMethed.unFreezeBalanceV2(
            httpnode, freezeBandwidthAddress, unfrozenBalance, 0, freezeBandwidthKey);
    ...
    responseContent =
        HttpMethed.parseResponseContent(HttpMethed.getAccount(httpnode, freezeBandwidthAddress));
  ...
  public void test003FreezeBalanceForEnergy() {
    ...
    response =
        HttpMethed.freezeBalanceV2(
            httpnode, freezeEnergyAddress, frozenEnergyBalance, 1, null, freezeEnergyKey);
    Assert.assertTrue(HttpMethed.verificationResult(response));
    HttpMethed.waitToProduceOneBlock(httpnode);
  ...
  public void test004UnFreezeBalanceForEnergy() {
    ...
    response =
        HttpMethed.unFreezeBalanceV2(
            httpnode, freezeEnergyAddress, unfrozenEnergyBalance, 1, freezeEnergyKey);
    ...
    responseContent =
        HttpMethed.parseResponseContent(HttpMethed.getAccount(httpnode, freezeEnergyAddress));
    JSONArray unfrozenV2 = responseContent.getJSONArray("unfrozenV2");
    Assert.assertTrue(unfrozenV2.size() == 1);
  ...
  public void test005DelegateResourceOfBandwidthForOthers() {
    ...
    responseContent =
        HttpMethed.parseResponseContent(HttpMethed.getAccount(httpnode, receiverResourceAddress));
  ...
  public void test007DelegateResourceOfEnergyForOthers() {
    ...
    Long delegatedFrozenBalanceForBandwidth =
        responseContent
            .getJSONObject("account_resource")
  ...
  public void test009WithdrawExpireUnfreeze() {
    ...
    response =
        HttpMethed.withdrawExpireUnfreeze(httpnode, freezeBandwidthAddress, freezeBandwidthKey);
    Assert.assertTrue(HttpMethed.verificationResult(response));
    HttpMethed.waitToProduceOneBlock(httpnode);
  ...
  public void test010GetCanDelegateMaxSize() {
    ...
    responseContent =
        HttpMethed.parseResponseContent(
    ...
    response =
        HttpMethed.freezeBalanceV2(
            httpnode, freezeForQuery, frozenBalance, 0, null, freezeForQueryKey);
    Assert.assertTrue(HttpMethed.verificationResult(response));

    // freeze energy
    response =
        HttpMethed.freezeBalanceV2(
            httpnode, freezeForQuery, frozenBalance, 1, null, freezeForQueryKey);
    Assert.assertTrue(HttpMethed.verificationResult(response));
  ...
  public void test012GetCanWithdrawUnfreezeAmount() {
    ...
    HttpMethed.freezeBalanceV2(
        httpnode, freezeForQuery, fronzenBalance, 0, null, freezeForQueryKey);
    responseContent =
        HttpMethed.parseResponseContent(
            HttpMethed.getCanWithdrawUnfreezeAmount(
                httpnode, freezeForQuery, System.currentTimeMillis(), false));
    Assert.assertNull(responseContent.getJSONObject("amount"));
    HttpMethed.waitToProduceOneBlockFromSolidity(httpnode, httpSoliditynode);
    response =
        HttpMethed.unFreezeBalanceV2(
            httpnode, freezeForQuery, unfronzenBalance, 0, freezeForQueryKey);
    responseContent = HttpMethed.parseResponseContent(response);
    HttpMethed.waitToProduceOneBlockFromSolidity(httpnode, httpSoliditynode);

    responseContent =
        HttpMethed.parseResponseContent(HttpMethed.getAccount(httpnode, freezeForQuery));
    ...
    responseContent =
        HttpMethed.parseResponseContent(
            HttpMethed.getCanWithdrawUnfreezeAmount(
                httpnode, freezeForQuery, unfreezeExpireTime - 1L, false));
    Assert.assertNull(responseContent.getJSONObject("amount"));
    // query solidity expire time-1
    responseContent =
        HttpMethed.parseResponseContent(
            HttpMethed.getCanWithdrawUnfreezeAmountSolidity(
                httpSoliditynode, freezeForQuery, unfreezeExpireTime - 1L, false));
    Assert.assertNull(responseContent.getJSONObject("amount"));
    ...
    responseContent =
        HttpMethed.parseResponseContent(
            HttpMethed.getCanWithdrawUnfreezeAmount(
                httpnode, freezeForQuery, unfreezeExpireTime + 1L, true));
    Assert.assertEquals(unfronzenBalance, responseContent.getLongValue("amount"));
    responseContent =
        HttpMethed.parseResponseContent(
            HttpMethed.getCanWithdrawUnfreezeAmountSolidity(
                httpSoliditynode, freezeForQuery, unfreezeExpireTime + 1L, true));
    Assert.assertEquals(unfronzenBalance, responseContent.getLongValue("amount"));
  }
    ...
    responseContent =
        HttpMethed.parseResponseContent(
            HttpMethed.getDelegatedResourceV2(
                httpnode, freezeForQuery, receiverResourceAddress, true));
    Assert.assertNull(responseContent.getJSONArray("delegatedResource"));
    responseContent =
        HttpMethed.parseResponseContent(
            HttpMethed.getDelegatedResourceV2Solidity(
                httpSoliditynode, freezeForQuery, receiverResourceAddress, true));
    Assert.assertNull(responseContent.getJSONArray("delegatedResource"));

    response =
        HttpMethed.freezeBalanceV2(
            httpnode, freezeForQuery, freezeAmount, 0, null, freezeForQueryKey);
    Assert.assertTrue(HttpMethed.verificationResult(response));
    response =
        HttpMethed.freezeBalanceV2(
            httpnode, freezeForQuery, freezeAmount, 1, null, freezeForQueryKey);
    Assert.assertTrue(HttpMethed.verificationResult(response));
    HttpMethed.waitToProduceOneBlockFromSolidity(httpnode, httpSoliditynode);
    response =
        HttpMethed.delegateresource(
    ...
    responseContent =
        HttpMethed.parseResponseContent(
            HttpMethed.getDelegatedResourceV2Pbft(
                httpPbftNode, freezeForQuery, receiverResourceAddress, true));
    delegateList = responseContent.getJSONArray("delegatedResource");
    delegateItem = null;
    for (int i = 0; i < delegateList.size(); i++) {
      if (delegateList
  ...
  public void test014GetDelegatedResourceAccountIndexV2() {
    ...
    Assert.assertTrue(
        responseContent
            .getJSONArray("fromAccounts")
            .contains(Base58.encode58Check(freezeForQuery)));
    // query solidity
    responseContent =
        HttpMethed.parseResponseContent(
            HttpMethed.getDelegatedResourceAccountIndexV2Solidity(
                httpSoliditynode, freezeForQuery, true));
    Assert.assertTrue(
        responseContent.getString("account").equals(Base58.encode58Check(freezeForQuery)));
    Assert.assertTrue(
        responseContent
    ...
    responseContent =
        HttpMethed.parseResponseContent(
            HttpMethed.getDelegatedResourceAccountIndexV2Solidity(
                httpSoliditynode, receiverResourceAddress, true));
    Assert.assertTrue(
        responseContent.getString("account").equals(Base58.encode58Check(receiverResourceAddress)));
    Assert.assertTrue(
        responseContent
    ...
    responseContent =
        HttpMethed.parseResponseContent(
            HttpMethed.getDelegatedResourceAccountIndexV2Pbft(httpPbftNode, freezeForQuery, true));
    Assert.assertTrue(
        responseContent.getString("account").equals(Base58.encode58Check(freezeForQuery)));
    Assert.assertTrue(
        responseContent
    ...
    responseContent =
        HttpMethed.parseResponseContent(
            HttpMethed.getDelegatedResourceAccountIndexV2Pbft(
                httpPbftNode, receiverResourceAddress, true));
    Assert.assertTrue(
        responseContent.getString("account").equals(Base58.encode58Check(receiverResourceAddress)));
    Assert.assertTrue(
        responseContent
  ...
  public void test011GetAvailableUnfreezeCount() {
    ...
    response =
        HttpMethed.freezeBalanceV2(
            httpnode, unfreezeAccount, freezeAmount, 0, null, unfreezeAccountKey);
    HttpMethed.waitToProduceOneBlockFromSolidity(httpnode, httpSoliditynode);
  ...
  public void test015lockPeriodTest() {
    ...
    Assert.assertEquals(
        responseContent
            .getJSONArray("delegatedResource")
            .getJSONObject(0)
            .getLong("frozen_balance_for_energy")
            .longValue(),
        delegateAmount.longValue());
    Assert.assertEquals(
        responseContent.getJSONArray("delegatedResource").getJSONObject(0).getString("from"),
        Base58.encode58Check(fromDelegateAddress));
    Assert.assertEquals(
        responseContent.getJSONArray("delegatedResource").getJSONObject(0).getString("to"),
  ...
  public void shutdown() throws InterruptedException {
    response =
        HttpMethed.unFreezeBalance(
            httpnode, fromAddress, frozenBalance, 0, freezeBandwidthAddress, testKey002);
