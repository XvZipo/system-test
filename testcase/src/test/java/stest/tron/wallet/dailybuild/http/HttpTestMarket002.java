...
@Slf4j
public class HttpTestMarket002 extends AbstractHttpEndpointsZen124 {
  ...
  public void test01MarketSellAsset() {
    ...
    txId2 =
        HttpMethed.marketSellAssetGetTxId(
            httpnode, sellAddress, assetIssueId1, 10L, assetIssueId2, 500L, sellKey, "false");
    HttpMethed.waitToProduceOneBlock(httpnode);
    logger.info(txId2);
    ...
    txId2 =
        HttpMethed.marketSellAssetGetTxId(
            httpnode, sellAddress, assetIssueId1, 10L, "_", 500L, sellKey, "false");
    HttpMethed.waitToProduceOneBlock(httpnode);
    logger.info(txId2);
    response = HttpMethed.getTransactionInfoById(httpnode, txId2);
    responseContent = HttpMethed.parseResponseContent(response);
  ...
  public void test02GetMarketOrderById() {
    ...
    Assert.assertEquals(
        ByteArray.toHexString(sellAddress), getMarketOrderByIdContent.getString("owner_address"));
    ...
    Assert.assertEquals(
        HttpMethed.str2hex(assetIssueId1), getMarketOrderByIdContent.getString("buy_token_id"));
  ...
  public void test03GetMarketOrderByIdFromSolidity() {
    ...
    Assert.assertEquals(
        ByteArray.toHexString(sellAddress),
    ...
    Assert.assertEquals(
        HttpMethed.str2hex(assetIssueId1),
  ...
  public void test06GetMarketOrderByAccountFromSolidity() {
    response =
        HttpMethed.getMarketOrderByAccountFromSolidity(httpSolidityNode, sellAddress, "false");
  ...
  public void test12GetMarketOrderListByPairFromSolidity() {
    response =
        HttpMethed.getMarketOrderListByPairFromSolidity(
            httpSolidityNode, "_", assetIssueId1, "false");
  ...
  public void test13GetMarketOrderListByPairFromPbft() {
    response =
        HttpMethed.getMarketOrderListByPairFromPbft(httpPbftNode, "_", assetIssueId1, "false");
  ...
  public void test14GetMarketPriceByPair() {
    ...
    Assert.assertEquals(
        HttpMethed.str2hex(assetIssueId1), getMarketPriceByPairContent.getString("buy_token_id"));
  ...
  public void test15GetMarketPriceByPairFromSolidity() {
    response =
        HttpMethed.getMarketPriceByPairFromSolidity(httpSolidityNode, "_", assetIssueId1, "false");
  ...
  public void test16GetMarketPriceByPairFromPbft() {
    response = HttpMethed.getMarketPriceByPairFromPbft(httpPbftNode, "_", assetIssueId1, "false");
