...
public class ContractInternalTransaction002 {
  ...
  public void test1InternalTransaction007() {
    ...
    String note5 =
        ByteArray.toStr(infoById1.get().getInternalTransactions(0).getNote().toByteArray());
  ...
  public void test2InternalTransaction008() {
    ...
    String note2 =
        ByteArray.toStr(infoById1.get().getInternalTransactions(0).getNote().toByteArray());
    String note3 =
        ByteArray.toStr(infoById1.get().getInternalTransactions(1).getNote().toByteArray());
    ...
    String note6 =
        ByteArray.toStr(infoById2.get().getInternalTransactions(1).getNote().toByteArray());
    ...
    String note7 =
        ByteArray.toStr(infoById3.get().getInternalTransactions(0).getNote().toByteArray());
    String note8 =
        ByteArray.toStr(infoById3.get().getInternalTransactions(1).getNote().toByteArray());
  ...
  public void test3InternalTransaction009() {
    ...
    String initParmes =
        "\""
            ...
            + "\",\""
            + Base58.encode58Check(contractAddress3)
            + "\",\""
    ...
    String note1 =
        ByteArray.toStr(infoById.get().getInternalTransactions(1).getNote().toByteArray());
    String note2 =
        ByteArray.toStr(infoById.get().getInternalTransactions(6).getNote().toByteArray());
    Long vaule1 = infoById.get().getInternalTransactions(0).getCallValueInfo(0).getCallValue();
    Long vaule2 = infoById.get().getInternalTransactions(1).getCallValueInfo(0).getCallValue();
    Assert.assertEquals("create", note);
    Assert.assertEquals("call", note1);
  ...
  public void test4InternalTransaction010() {
    ...
    for (int i = 0; i < transactionsCount1; i++) {
      ...
      Assert.assertEquals(
          1, infoById1.get().getInternalTransactions(i).getCallValueInfo(0).getCallValue());
    }
  }
