...
public class Accounts001 extends JsonRpcBase {
  ...
  public void test04JsonRpcApiTestForEthChainId() throws Exception {
    ...
    response = HttpMethed.getBlockByNum(httpFullNode, 0L);
    responseContent = HttpMethed.parseResponseContent(response);
  ...
  public void test48JsonRpcApiTestForEthGetBlockByHash() throws Exception {
    ...
    Assert.assertEquals("0x0000000000000000", getBlockByHashResult.getString("nonce"));
  ...
  public void test49JsonRpcApiTestForEthGetBlockByNumber() throws Exception {
    ...
    Assert.assertNotNull(getBlockByNumberResult.getString("nonce"));
    Assert.assertNotNull(getBlockByNumberResult.getString("sha3Uncles"));
    Assert.assertNotNull(getBlockByNumberResult.getString("receiptsRoot"));
    Assert.assertNotNull(getBlockByNumberResult.getString("difficulty"));
    Assert.assertNotNull(getBlockByNumberResult.getString("totalDifficulty"));
    Assert.assertNotNull(getBlockByNumberResult.getString("extraData"));
    Assert.assertNotNull(getBlockByNumberResult.getString("baseFeePerGas"));
    Assert.assertNotNull(getBlockByNumberResult.getString("mixHash"));
  ...
  public void test50JsonRpcApiTestForInterfaceCombination() throws Exception {
    ...
    response = getJsonRpc(jsonRpcNode, jsonArrayParams);
...
//    Assert.assertEquals(trans1, trans2);
  ...
  public void test57JsonRpcApiTestForEthGetBlockReceipts() throws Exception {
    ...
    while (count-->0){
      ...
      String txId =
          PublicMethed.triggerContract(
              Base58.decode58CheckForShield("TMeSGNXiz3f8PGhWdFV76o5efKFBtdaJGq"),
              selector,
              paramString,
              true,
              0,
    ...
    Assert.assertTrue(targetBlockNum > 0);
