...
public class DynamicEnergyTest001 {
  ...
  public void beforeClass() throws Exception {
    ...
    chainMaxFeeLimit =
        PublicMethed.getChainParametersValue(
            ProposalEnum.getMaxFeeLimit.getProposalName(), blockingStubFull);
    energyFee =
        PublicMethed.getChainParametersValue(
    ...
    PublicMethed.sendcoin(
        testAccountAddress, sendAmount, foundationAddress, foundationKey, blockingStubFull);
    ...
    contractAddress =
        PublicMethed.getTransactionInfoById(txid, blockingStubFull)
            ...
            .getContractAddress()
            .toByteArray();
    Long nextMaintainTime =
        blockingStubFull.getNextMaintenanceTime(EmptyMessage.newBuilder().build()).getNum();
  ...
  public void test01GetContractStatus() throws Exception {
    ContractState contractState =
        PublicMethed.getContractInfo(contractAddress, blockingStubFull).getContractState();
    ...
    Long getDynamicEnergyThreshold =
        PublicMethed.getChainParametersValue(
            ProposalEnum.GetDynamicEnergyThreshold.getProposalName(), blockingStubFull);
    Long getDynamicEnergyIncreaseFactor =
        PublicMethed.getChainParametersValue(
            ProposalEnum.GetDynamicEnergyIncreaseFactor.getProposalName(), blockingStubFull);
    ...
    TransactionInfo transactionInfo =
        PublicMethed.getTransactionInfoById(transactionId, blockingStubFull).get();
    ...
    Assert.assertTrue(
        penaltyEnergy
            <= (Long)
                ((penaltyEnergyTotal - penaltyEnergy) * contractState.getEnergyFactor() / 10000));
    Assert.assertTrue(
        penaltyEnergy
            >= (Long)
                    ((penaltyEnergyTotal - penaltyEnergy) * contractState.getEnergyFactor() / 10000)
  ...
  public void shutdown() throws InterruptedException {
    PublicMethed.freedResource(
        testAccountAddress, testAccountKey, foundationAddress, blockingStubFull);
    if (channelFull != null) {
      channelFull.shutdown().awaitTermination(5, TimeUnit.SECONDS);
    }
  }
