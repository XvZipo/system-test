...
public class ResourcePriceTest001 {
  ...
  public void beforeClass() {
    ...
    channelSolidityPort =
        ManagedChannelBuilder.forTarget(fullNodeSolidityPort).usePlaintext().build();
  ...
  public void test02GetEnergyPrices() {
    ...
    Long energyPriceChainParameters =
    ...
    String energyPricesSolidityPort =
        PublicMethed.getEnergyPriceSolidity(blockingStubFullSolidityPort);
  ...
  public void test02GetBandwidthPrices() {
    ...
    Long bandwidthPriceChainParameters =
        PublicMethed.getChainParametersValue(
    ...
    String bandwidthPricesSolidity =
        PublicMethed.getBandwidthPricesSolidity(blockingStubFullSolidity);
    String bandwidthPricesSolidityPort =
        PublicMethed.getBandwidthPricesSolidity(blockingStubFullSolidityPort);
