...
public class WalletTestAccount013 {
  ...
  public void test1DelegateResourceForBandwidthAndEnergy() {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            account013Address, 10000000000L, fromAddress, testKey002, blockingStubFull));
    // sendcoin to receiver
    Assert.assertTrue(
        PublicMethed.sendcoin(
            receiverDelegateAddress, 10000000000L, toAddress, testKey003, blockingStubFull));

    // getAccountResource account013
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    AccountResourceMessage account013Resource =
    ...
    AccountResourceMessage receiverResource =
    ...
    AccountResourceMessage account013ResBefore =
        PublicMethed.getAccountResource(account013Address, blockingStubFull);
    final long account013BeforeBandWidth = account013ResBefore.getNetLimit();
    AccountResourceMessage receiverResourceBefore =
        PublicMethed.getAccountResource(receiverDelegateAddress, blockingStubFull);
    ...
    Assert.assertTrue(
        PublicMethed.freezeBalanceForReceiver(
            ...
            freezeDuration,
            0,
            ByteString.copyFrom(receiverDelegateAddress),
            testKeyForAccount013,
            blockingStubFull));
    ...
    Assert.assertFalse(
        PublicMethed.freezeBalanceForReceiver(
            ...
            freezeDuration,
            0,
            ByteString.copyFrom(emptyAddress),
            testKeyForAccount013,
            blockingStubFull));
    ...
    Assert.assertFalse(
        PublicMethed.freezeBalanceForReceiver(
            ...
            freezeDuration,
            0,
            ByteString.copyFrom(account013Address),
            testKeyForAccount013,
            blockingStubFull));
  ...
  public void test2getDelegatedResource() {
    ...
    Assert.assertTrue(
        PublicMethed.freezeBalanceForReceiver(
            ...
            freezeDuration,
            0,
            ByteString.copyFrom(account4DelegatedResourceAddress),
            testKeyForAccount013,
            blockingStubFull));
    ...
    Assert.assertTrue(
        PublicMethed.freezeBalanceForReceiver(
            ...
            freezeDuration,
            1,
            ByteString.copyFrom(account5DelegatedResourceAddress),
            account4DelegatedResourceKey,
            blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    ...
    Optional<GrpcAPI.DelegatedResourceList> delegatedResourceResult2 =
        PublicMethed.getDelegatedResource(
            account4DelegatedResourceAddress, account5DelegatedResourceAddress, blockingStubFull);
    ...
    Assert.assertTrue(
        new String(account013Address)
            .equals(
                new String(delegatedResourceIndexResult1.get().getFromAccounts(0).toByteArray())));
    // result of To list, first Address is same as Account5 address
    Assert.assertTrue(
        new String(account5DelegatedResourceAddress)
            .equals(
    ...
    Assert.assertTrue(
        PublicMethed.queryAccount(account013Address, blockingStubFull).getBalance()
  ...
  public void test3PrepareToken() {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            accountForAssetIssueAddress, 10000000000L, toAddress, testKey003, blockingStubFull));
  ...
  public void test4DelegateResourceAboutTransferAsset() {
    ...
    getAssetIdFromThisAccount =
        PublicMethed.queryAccount(accountForAssetIssueAddress, blockingStubFull);
    ByteString assetAccountId = getAssetIdFromThisAccount.getAssetIssuedID();
    // Account5 Participate AssetIssue
    Assert.assertTrue(
        PublicMethed.participateAssetIssue(
            accountForAssetIssueAddress,
    ...
    final long account013CurrentBandwidth =
        PublicMethed.getAccountResource(account013Address, blockingStubFull).getNetUsed();
    long accountForAssetIssueCurrentBandwidth =
        PublicMethed.getAccountResource(accountForAssetIssueAddress, blockingStubFull).getNetUsed();
    final long account5CurrentBandwidth =
        PublicMethed.getAccountResource(account5DelegatedResourceAddress, blockingStubFull)
            .getNetUsed();
    // Account5 transfer Assets receiver
    Assert.assertTrue(
        PublicMethed.transferAsset(
            receiverDelegateAddress,
            assetAccountId.toByteArray(),
            100000,
            account5DelegatedResourceAddress,
            account5DelegatedResourceKey,
    ...
    final long account013CurrentBandwidthAfterTrans =
        PublicMethed.getAccountResource(account013Address, blockingStubFull).getNetUsed();
    final long accountForAssetIssueCurrentBandwidthAfterTrans =
        PublicMethed.getAccountResource(accountForAssetIssueAddress, blockingStubFull)
            .getFreeNetUsed();
    final long account5CurrentBandwidthAfterTrans =
        PublicMethed.getAccountResource(account5DelegatedResourceAddress, blockingStubFull)
            .getNetUsed();
    AccountResourceMessage account5ResourceAfterTrans =
        PublicMethed.getAccountResource(account5DelegatedResourceAddress, blockingStubFull);
  ...
  public void test5CanNotDelegateResourceToContract() {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            accountForDeployAddress, 10000000000L, fromAddress, testKey002, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
  ...
  public void test6GetDelegateResourceFromSolidity() {
    Optional<GrpcAPI.DelegatedResourceList> delegateResource =
        PublicMethed.getDelegatedResourceFromSolidity(
            account013Address, receiverDelegateAddress, blockingStubSolidity);
    Assert.assertTrue(
        delegateResource.get().getDelegatedResource(0).getFrozenBalanceForEnergy() == 10000000);
    Assert.assertTrue(
        delegateResource.get().getDelegatedResource(0).getFrozenBalanceForBandwidth() == 10000000);
  }
  ...
  public void test7GetDelegateResourceFromPbft() {
    Optional<GrpcAPI.DelegatedResourceList> delegateResource =
        PublicMethed.getDelegatedResourceFromSolidity(
            account013Address, receiverDelegateAddress, blockingStubPbft);
    Assert.assertTrue(
        delegateResource.get().getDelegatedResource(0).getFrozenBalanceForEnergy() == 10000000);
    Assert.assertTrue(
        delegateResource.get().getDelegatedResource(0).getFrozenBalanceForBandwidth() == 10000000);
  ...
  public void test8GetDelegateResourceIndexFromSolidity() {
    Optional<Protocol.DelegatedResourceAccountIndex> delegateResourceIndex =
        PublicMethed.getDelegatedResourceAccountIndexFromSolidity(
            account013Address, blockingStubSolidity);
  ...
  public void shutdown() throws InterruptedException {
    PublicMethed.freedResource(
        account013Address, testKeyForAccount013, fromAddress, blockingStubFull);
    PublicMethed.freedResource(
        receiverDelegateAddress, receiverDelegateKey, fromAddress, blockingStubFull);
    PublicMethed.freedResource(
        account4DelegatedResourceAddress,
        account4DelegatedResourceKey,
        fromAddress,
