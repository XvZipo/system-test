...
@Slf4j
public class MultiSignProposalTest002 extends TronBaseTest {
  ...
  //Get proposal list
    ...
    Assert.assertTrue(PublicMethodForMultiSign.approveProposalWithPermission(
        witness001Address, witnessKey, finalProposalId,
  ...
  //Delete proposal list after approve
    Assert.assertTrue(PublicMethodForMultiSign.deleteProposalWithPermissionId(
        witness001Address, witnessKey, finalProposalId, 2, blockingStubFull, permissionKeyString));
    PublicMethod.waitProduceNextBlock(blockingStubFull);
