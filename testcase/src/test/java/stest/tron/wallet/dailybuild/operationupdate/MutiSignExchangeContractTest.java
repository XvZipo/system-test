...
public class MutiSignExchangeContractTest {
  ...
  public void test1CreateUsedAsset() {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            exchange001Address, 10240000000L, fromAddress, testKey002, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.sendcoin(
    ...
    Assert.assertTrue(
        PublicMethed.freezeBalanceForReceiver(
            fromAddress,
            100000000000L + PublicMethed.randomFreezeAmount.addAndGet(1),
            0,
            0,
  ...
  public void test2CreateExchange() {
    ...
    Long balanceBefore =
        PublicMethed.queryAccount(exchange001Address, blockingStubFull).getBalance();
    ...
    exchangeId =
        PublicMethed.getExchangeIdByCreatorAddress(exchange001Address, blockingStubFull).intValue();
