...
@Slf4j
public class MutiSignProposalTest extends AbstractGrpcFullSolidityTest {
  ...
  public void testMutiSignForProposal() {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            witness001Address, needcoin + 10000000L, fromAddress, testKey002, blockingStubFull));
    ...
    Long balanceBefore =
        PublicMethed.queryAccount(witness001Address, blockingStubFull).getBalance();
    ...
    PublicMethedForMutiSign.accountPermissionUpdate(
        accountPermissionJson, witness001Address, witnessKey001, blockingStubFull, ownerKeyString);
    ...
    Assert.assertTrue(
        PublicMethedForMutiSign.createProposalWithPermissionId(
            witness001Address, witnessKey001, proposalMap, 0, blockingStubFull, ownerKeyString));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    // Get proposal list
