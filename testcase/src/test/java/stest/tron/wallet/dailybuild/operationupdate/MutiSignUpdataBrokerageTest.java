...
@Slf4j
public class MutiSignUpdataBrokerageTest extends AbstractGrpcFullSolidityTest {
  ...
  public void testMutiSignForUpdateBrokerage() {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            witness001Address, needcoin + 1000000L, fromAddress, testKey002, blockingStubFull));
    ...
    Assert.assertTrue(
        PublicMethedForMutiSign.updateBrokerage(
            witness001Address, 70, witnessKey001, 2, permissionKeyString, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    //    PublicMethed.waitProduceNextBlock(blockingStubFull);
