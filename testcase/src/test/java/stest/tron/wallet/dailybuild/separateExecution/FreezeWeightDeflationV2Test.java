...
public class FreezeWeightDeflationV2Test {
  ...
  public void beforeClass() throws Exception {
    ...
    Assert.assertTrue(
        PublicMethed.freezeBalanceV2(
            foundationAddress, frozenAmount * 30, 0, foundationKey, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.freezeBalanceV2(
            foundationAddress, frozenAmount * 30, 1, foundationKey, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
  ...
  @Test(
      enabled = true,
      priority = 3,
      description = "Freeze net cause weight deflation issue fix test")
  public void test01FreezeNetCauseWeightDeflationTest() {
    ...
    Assert.assertTrue(
        PublicMethed.unFreezeBalanceV2(
            frozen1Address, frozen1Key, frozenAmount * 2, 0, blockingStubFull));

    PublicMethed.waitProduceNextBlock(blockingStubFull);

    Long unfreezeTimestamp =
        PublicMethed.queryAccount(frozen1Address, blockingStubFull)
            .getUnfrozenV2(0)
  ...
  @Test(
      enabled = true,
      priority = 3,
      description = "Freeze energy cause weight deflation issue fix test")
  public void test02FreezeEnergyCauseWeightDeflationTest() {
    ...
    Assert.assertTrue(
        PublicMethed.unFreezeBalanceV2(
            frozen1Address, frozen1Key, frozenAmount * 2, 1, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
