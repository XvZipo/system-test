  ...
  public void deployTransferTokenContract() {
    Assert.assertTrue(
        PublicMethed.sendcoin(
            dev001Address, 1100_000_000L, fromAddress, testKey002, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.sendcoin(
            user001Address, 1100_000_000L, fromAddress, testKey002, blockingStubFull));
    ...
    // PublicMethed.randomFreezeAmount.getAndAdd(1), 0, 0,
    ...
    Long devAssetCountBefore =
        PublicMethed.getAssetIssueValue(dev001Address, assetAccountDev, blockingStubFull);
    Long userAssetCountBefore =
        PublicMethed.getAssetIssueValue(dev001Address, assetAccountUser, blockingStubFull);
    ...
    logger.info(
        "before dev has AssetId: "
            + assetAccountDev.toStringUtf8()
            + ", devAssetCountBefore: "
            + devAssetCountBefore);
    logger.info(
        "before dev has AssetId: "
            + assetAccountUser.toStringUtf8()
    ...
    Assert.assertEquals(
        "contract validate error : No asset !".toLowerCase(),
    ...
    Assert.assertEquals(CONTRACT_VALIDATE_ERROR, response.getCode());
    Assert.assertEquals(
        "contract validate error : assetBalance must greater than 0.".toLowerCase(),
        response.getMessage().toStringUtf8().toLowerCase());
    ...
    Assert.assertEquals(CONTRACT_VALIDATE_ERROR, response.getCode());
    Assert.assertEquals(
        "contract validate error : assetBalance is not sufficient.".toLowerCase(),
        response.getMessage().toStringUtf8().toLowerCase());
    ...
    Assert.assertEquals(CONTRACT_VALIDATE_ERROR, response.getCode());
    Assert.assertEquals(
        "contract validate error : tokenId must be > 1000000".toLowerCase(),
        response.getMessage().toStringUtf8().toLowerCase());
    ...
    Assert.assertEquals(CONTRACT_VALIDATE_ERROR, response.getCode());
    Assert.assertEquals(
        "contract validate error : tokenValue must be >= 0".toLowerCase(),
        response.getMessage().toStringUtf8().toLowerCase());
    ...
    logger.info(
        "after dev has AssetId: "
            + assetAccountDev.toStringUtf8()
            + ", devAssetCountAfter: "
            + devAssetCountAfter);
    logger.info(
        "after user has AssetId: "
            + assetAccountDev.toStringUtf8()
            + ", userAssetCountAfter: "
            + userAssetCountAfter);
