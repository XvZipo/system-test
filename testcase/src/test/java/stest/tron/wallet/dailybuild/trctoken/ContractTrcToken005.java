...
public class ContractTrcToken005 {
  ...
  public void deployTransferTokenContract() {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            user001Address, 2000_000_000L, fromAddress, testKey002, blockingStubFull));
    ...
    Long userAssetId =
        PublicMethed.getAssetIssueValue(
            user001Address, ByteString.copyFromUtf8(tokenId), blockingStubFull);
    ...
    GrpcAPI.Return response =
        PublicMethed.triggerContractAndGetResponse(
