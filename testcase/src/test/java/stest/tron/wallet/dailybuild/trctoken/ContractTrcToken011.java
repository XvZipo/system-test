...
public class ContractTrcToken011 {
  ...
  public void test01DeployTransferTokenContract001() {
    Assert.assertTrue(
        PublicMethed.sendcoin(
            dev001Address, 15048_000_000L, fromAddress, testKey002, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.sendcoin(
            user001Address, 14048_000_000L, fromAddress, testKey002, blockingStubFull));
    // drop freezeBalanceForReceiver, for transaction null
  ...
  public void test04TriggerTokenBalanceContract004() {
    ...
    Long triggerResult = ByteArray.toLong(infoById.get().getContractResult(0).toByteArray());
