...
public class ContractTrcToken012 {
  ...
  public void test02TriggerContract() {
    ...
    Long receiveAssetBefore =
        PublicMethed.getAssetIssueValue(dev001Address, assetAccountId, blockingStubFull);
    logger.info(
        "before trigger, receiveTokenContractAddress has AssetId "
            + assetAccountId.toStringUtf8()
            + ", Count is "
            + receiveAssetBefore);
    ...
    String param =
        "\"" + Base58.encode58Check(dev001Address) + "\",\"" + tokenValue + "\"," + tokenId;
  ...
  public void test03TriggerTokenBalanceContract() {
    ...
    String param =
        "\"" + Base58.encode58Check(dev001Address) + "\",\"" + assetAccountId.toStringUtf8() + "\"";
    ...
    Long assetAccountCount = ByteArray.toLong(infoById.get().getContractResult(0).toByteArray());
