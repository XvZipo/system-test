...
public class ContractTrcToken014 {
  ...
  @Test(
      enabled = true,
      description =
          "TransferToken with tokenId in exception condition," + " deploy transfer contract")
  public void test01DeployTransferTokenContract() {
    Assert.assertTrue(
        PublicMethed.sendcoin(
            dev001Address, 11000_000_000L, fromAddress, testKey002, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.sendcoin(
            user001Address, 11000_000_000L, fromAddress, testKey002, blockingStubFull));
    ...
    assetAccountUser =
        PublicMethed.queryAccount(user001Address, blockingStubFull).getAssetIssuedID();
  ...
  @Test(
      enabled = true,
      description =
          "TransferToken with tokenId in exception condition," + " deploy receiver contract")
  ...
  @Test(
      enabled = true,
      description = "TransferToken with tokenId in exception condition," + " transfer to contract")
  public void test03TriggerContract() {
    ...
    Long devAssetBefore =
        PublicMethed.getAssetIssueValue(dev001Address, assetAccountId, blockingStubFull);
    logger.info(
        "before trigger, dev001Address has AssetId "
            + assetAccountId.toStringUtf8()
            + ", Count is "
            + devAssetBefore);
    ...
    param =
        "\"" + Base58.encode58Check(dev001Address) + "\"," + fakeValue + ",\"" + fackTokenId + "\"";
    ...
    Assert.assertEquals(FAILED, infoById.get().getResult());
    Assert.assertEquals(
        "endowment out of long range", infoById.get().getResMessage().toStringUtf8());
    ...
    Long devAssetAfter =
        PublicMethed.getAssetIssueValue(dev001Address, assetAccountId, blockingStubFull);
    logger.info(
        "after trigger, dev001Address has AssetId "
            + assetAccountId.toStringUtf8()
            + ", Count is "
            + devAssetAfter);
