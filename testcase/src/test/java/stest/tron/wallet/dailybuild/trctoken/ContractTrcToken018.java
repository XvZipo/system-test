...
public class ContractTrcToken018 {
  ...
  public void testDeployTransferTokenContract() {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            user001Address, 2200_000_000L, fromAddress, testKey002, blockingStubFull));
    ...
    // PublicMethed.randomFreezeAmount.addAndGet(1), 0, 0,
    ...
    Long receiveAssetBefore =
        PublicMethed.getAssetIssueValue(tmpAddress, assetAccountId, blockingStubFull);
    logger.info(
    ...
    Long receiveAssetAfter =
        PublicMethed.getAssetIssueValue(tmpAddress, assetAccountId, blockingStubFull);
    logger.info(
        "after trigger, receiveTokenAddress has AssetId "
            + assetAccountId.toStringUtf8()
