...
public class ContractTrcToken030 {
  ...
  public void deploy02TransferTokenContract() {
    ...
    Assert.assertTrue(
        beforeAssetIssueUserAddress + beforeAssetIssueContractAddress
            == afterAssetIssueUserAddress);
    Assert.assertTrue(beforeUserBalance + beforeBalanceContractAddress == afterUserBalance);
  }
