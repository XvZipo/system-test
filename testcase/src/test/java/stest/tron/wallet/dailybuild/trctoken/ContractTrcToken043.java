...
public class ContractTrcToken043 {
  ...
  public void test01DeployTransferTokenContract() {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            user001Address, 5048_000_000L, fromAddress, testKey002, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.sendcoin(
            user002Address, 5048_000_000L, fromAddress, testKey002, blockingStubFull));
  ...
  public void test03TriggerContract() {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(user002Address, 5000000, fromAddress, testKey002, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    ...
    triggerTxid =
        PublicMethed.triggerContract(
            transferTokenContractAddress,
            "transferTokenTestIDOverBigInteger(address)",
            param,
            false,
            callValue,
            1000000000L,
