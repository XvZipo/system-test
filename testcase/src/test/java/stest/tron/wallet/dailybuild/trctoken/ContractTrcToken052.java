...
public class ContractTrcToken052 {
  ...
  public void deployTransferTokenContract() {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            user001Address, 6048000000L, fromAddress, testKey002, blockingStubFull));
    ...
    Long beforeAssetIssueDev =
        PublicMethed.getAssetIssueValue(dev001Address, assetAccountId, blockingStubFull);
    final Long beforetransferTokenContractAddressBalance =
        PublicMethed.queryAccount(transferTokenContractAddress, blockingStubFull).getBalance();
    final Long beforeDevBalance =
        PublicMethed.queryAccount(dev001Address, blockingStubFull).getBalance();
    ...
    Long afterAssetIssueContractAddress =
        PublicMethed.getAssetIssueValue(
            transferTokenContractAddress, assetAccountId, blockingStubFull);
    Long afterAssetIssueDev =
        PublicMethed.getAssetIssueValue(dev001Address, assetAccountId, blockingStubFull);
    final Long aftertransferTokenContractAddressBalance =
        PublicMethed.queryAccount(transferTokenContractAddress, blockingStubFull).getBalance();
    final Long afterDevBalance =
        PublicMethed.queryAccount(dev001Address, blockingStubFull).getBalance();
