...
public class ContractTrcToken064 {
  ...
  @Test(
      enabled = true,
      description =
          "TransferToken with 0 tokenValue and "
              + "tokenId in exception condition, deploy transfer contract")
  public void test01DeployTransferTokenContract() {
    Assert.assertTrue(
        PublicMethed.sendcoin(
            dev001Address, 5100_000_000L, fromAddress, testKey002, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.sendcoin(
            user001Address, 5100_000_000L, fromAddress, testKey002, blockingStubFull));
  ...
  public void test03TriggerContract() {
    ...
    String triggerTxid =
        PublicMethed.triggerContract(
            ...
            "transferTokenTestValue0IdBigInteger(address)",
            param,
            false,
            callValue,
            1000000000L,
    ...
    triggerTxid =
        PublicMethed.triggerContract(
            transferTokenContractAddress,
            "transferTokenTestValueMaxLong(address)",
            param,
            false,
            callValue,
            1000000000L,
