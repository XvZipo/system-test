...
public class ContractTrcToken077 {
  ...
  public void testAddress001() {
    PublicMethed.sendcoin(
        grammarAddress, 100000000000L, testNetAccountAddress, testNetAccountKey, blockingStubFull);
    ...
    String deployTxid =
        PublicMethed.deployContractAndGetTransactionInfoById(
            ...
            100,
            null,
            testKeyForGrammarAddress,
            grammarAddress,
            blockingStubFull);
    Optional<TransactionInfo> deployInfo =
  ...
  public void testAddress002() {
    ...
    String code =
        "608060405234801561001057600080fd5b50d3801561001d57600080fd5b50d2801561002a57600"
    ...
    String deploytxid =
        PublicMethed.deployContractAndGetTransactionInfoById(
            ...
            blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Optional<TransactionInfo> deployById =
        PublicMethed.getTransactionInfoById(deploytxid, blockingStubFull);
  ...
  public void shutdown() throws InterruptedException {
    PublicMethed.freedResource(
        grammarAddress, testKeyForGrammarAddress, testNetAccountAddress, blockingStubFull);
    if (channelFull != null) {
