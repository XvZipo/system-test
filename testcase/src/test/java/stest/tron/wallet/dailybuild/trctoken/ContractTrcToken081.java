...
public class ContractTrcToken081 {
  ...
  public void beforeClass() {
    ...
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    SmartContract smartContract = PublicMethed.getContract(tokenReceiver, blockingStubFull);
    ...
    tokenSender =
        PublicMethed.deployContract(
            ...
            blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    smartContract = PublicMethed.getContract(tokenSender, blockingStubFull);
    Assert.assertNotNull(smartContract.getAbi());

    Long contractAssetCount =
        PublicMethed.getAssetIssueValue(tokenSender, assetAccountId, blockingStubFull);
    logger.info(
        "tokenSender has AssetId before: "
            + assetAccountId.toStringUtf8()
            + ", Count: "
            + contractAssetCount);

    Long devAssetCountAfterDeploy =
        PublicMethed.getAssetIssueValue(dev001Address, assetAccountId, blockingStubFull);
    logger.info(
        "after deploy tokenSender AssetId: "
            + assetAccountId.toStringUtf8()
            + ", devAssetCountAfter: "
  ...
  public void transferTokenToContract() {
    Long senderAssetCountBefore =
        PublicMethed.getAssetIssueValue(tokenSender, assetAccountId, blockingStubFull);
    logger.info(
        "before trigger tokenSender has AssetId before: "
            + assetAccountId.toStringUtf8()
            + ", Count: "
            + senderAssetCountBefore);

    Long receiverAssetCountBefore =
        PublicMethed.getAssetIssueValue(tokenReceiver, assetAccountId, blockingStubFull);
    logger.info(
        "before trigger tokenReceiver AssetId: "
            + assetAccountId.toStringUtf8()
            + ", Count: "
    ...
    Long senderAssetCountAfter =
        PublicMethed.getAssetIssueValue(tokenSender, assetAccountId, blockingStubFull);
    logger.info(
        "tokenSender has AssetId After trigger: "
            + assetAccountId.toStringUtf8()
            + ", Count: "
            + senderAssetCountAfter);

    Long receiverAssetCountAfterTrigger =
        PublicMethed.getAssetIssueValue(tokenReceiver, assetAccountId, blockingStubFull);
    logger.info(
        "after trigger AssetId: "
            + assetAccountId.toStringUtf8()
            + ", Count: "
  ...
  public void transferTokenToNormalAddress() {
    ...
    long devAssetCountBeforeTrigger =
        PublicMethed.getAssetIssueValue(dev001Address, assetAccountId, blockingStubFull);
    logger.info(
        "after trigger AssetId: "
            + assetAccountId.toStringUtf8()
    ...
    long devAssetCountAfterTrigger =
        PublicMethed.getAssetIssueValue(dev001Address, assetAccountId, blockingStubFull);
    logger.info(
        "after trigger AssetId: "
            + assetAccountId.toStringUtf8()
