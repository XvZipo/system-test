...
public class Create2Test004 {
  ...
  public void test02TriggerCreate2ToDeployFactory2Contract() {
    Assert.assertTrue(
        PublicMethed.freezeBalanceForReceiver(
            ...
            PublicMethed.getFreezeBalanceCount(
                user001Address, user001Key, 150000L, blockingStubFull),
            0,
            1,
    ...
    SmartContract smartContract =
        PublicMethed.getContract(factoryContractAddress2, blockingStubFull);
  ...
  public void test03TriggerCreate2ToDeployTestContract() {
    Assert.assertTrue(
        PublicMethed.freezeBalanceForReceiver(
            fromAddress,
            PublicMethed.getFreezeBalanceCount(
                user001Address, user001Key, 80000L, blockingStubFull),
            0,
            1,
            ByteString.copyFrom(user001Address),
            testKey002,
    ...
    Assert.assertNotEquals(
        Base58.encode58Check(factoryContractAddress), Base58.encode58Check(testContractAddress));
  }
