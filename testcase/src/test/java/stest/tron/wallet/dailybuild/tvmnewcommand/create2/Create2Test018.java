...
public class Create2Test018 {
  ...
  private String witnessKey001 = Configuration.getByPath("testng.conf").getString("witness.key2");
  ...
  public void test01DeployFactoryContract() {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            witnessAddress001, 100_000_000L, fromAddress, testKey002, blockingStubFull));
    Assert.assertTrue(
  ...
  @Test(
      enabled = false,
      description = "Trigger create2 function to deploy test contract " + "using Witness account")
  public void test02TriggerCreate2ToDeployTestContract() {
    Assert.assertTrue(
        PublicMethed.freezeBalanceForReceiver(
            ...
            0,
            1,
            ByteString.copyFrom(witnessAddress001),
            testKey002,
            blockingStubFull));
    ...
    long userBalanceBefore =
        PublicMethed.queryAccount(witnessAddress001, blockingStubFull).getBalance();
  ...
  public void test03TriggerTestContract() {
    ...
    Assert.assertTrue(
        PublicMethed.freezeBalanceForReceiver(
            ...
            PublicMethed.getFreezeBalanceCount(
                witnessAddress001, witnessKey001, 50000L, blockingStubFull),
            0,
            1,
            ByteString.copyFrom(witnessAddress001),
            testKey002,
    ...
    PublicMethed.unFreezeBalance(fromAddress, testKey002, 1, witnessAddress001, blockingStubFull);
    PublicMethed.unFreezeBalance(fromAddress, testKey002, 0, witnessAddress001, blockingStubFull);
  }
