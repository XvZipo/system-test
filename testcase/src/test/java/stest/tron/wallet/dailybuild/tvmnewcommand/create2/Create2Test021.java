...
public class Create2Test021 {
  ...
  public void test1TriggerContract() {
    ...
    Assert.assertTrue(
        PublicMethed.freezeBalanceForReceiver(
            ...
            0,
            0,
            ByteString.copyFrom(resourceOnwerAddress),
            testNetAccountKey,
            blockingStubFull));
    Assert.assertTrue(
        PublicMethed.freezeBalanceForReceiver(
    ...
    Long beforeExcAccountBalance =
        PublicMethed.queryAccount(resourceOnwerAddress, blockingStubFull).getBalance();
    ...
    Assert.assertFalse(
        PublicMethed.freezeBalanceForReceiver(
            ...
            resourceOnwerKey,
            blockingStubFull));
    Long afterExcAccountBalance =
        PublicMethed.queryAccount(resourceOnwerAddress, blockingStubFull).getBalance();
    Assert.assertTrue(PublicMethed.getAccountResource(bytes, blockingStubFull).getNetLimit() == 0);
    Assert.assertTrue(
        PublicMethed.getAccountResource(bytes, blockingStubFull).getEnergyLimit() == 0);
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            bytes, 1000000L, contractExcAddress, contractExcKey, blockingStubFull));
    // Trigger contract to transfer trx and token.
    Account getAssetIdFromAccount =
        PublicMethed.queryAccount(resourceOnwerAddress, blockingStubFull);
    ...
    Assert.assertTrue(
        PublicMethed.unFreezeBalance(
            resourceOnwerAddress, resourceOnwerKey, 0, bytes, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.unFreezeBalance(
            resourceOnwerAddress, resourceOnwerKey, 1, bytes, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Long afterUnfreezeBalance =
        PublicMethed.queryAccount(resourceOnwerAddress, blockingStubFull).getBalance();
  ...
  public void test2TriggerContract() {
    ...
    Account contractExcAddressbefore =
        PublicMethed.queryAccount(contractExcAddress, blockingStubFull);
    ...
    String txid =
        PublicMethed.triggerContract(
            ...
            blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Optional<TransactionInfo> transactionInfoById =
    ...
    Account contractExcAddressafter =
        PublicMethed.queryAccount(contractExcAddress, blockingStubFull);
    ...
    Long returnAddressBytesAccountCountBefore =
        PublicMethed.getAssetIssueValue(bytes, assetAccountId, blockingStubFull);
    Long contractExcAddressAccountCountBefore =
        PublicMethed.getAssetIssueValue(contractExcAddress, assetAccountId, blockingStubFull);
    String txid1 =
        PublicMethed.triggerContract(
            bytes,
            "testTransferToken(uint256,trcToken)",
            num,
            false,
            0,
            maxFeeLimit,
            ...
            blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Optional<TransactionInfo> transactionInfoById1 =
        PublicMethed.getTransactionInfoById(txid1, blockingStubFull);
    Assert.assertTrue(transactionInfoById1.get().getResultValue() == 0);
    Long returnAddressBytesAccountCountAfter =
        PublicMethed.getAssetIssueValue(bytes, assetAccountId, blockingStubFull);

    Long contractExcAddressAccountCountAfter =
        PublicMethed.getAssetIssueValue(contractExcAddress, assetAccountId, blockingStubFull);
    Assert.assertTrue(
  ...
  public void shutdown() throws InterruptedException {
    Assert.assertTrue(
        PublicMethed.unFreezeBalance(
            testNetAccountAddress, testNetAccountKey, 0, resourceOnwerAddress, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.unFreezeBalance(
            testNetAccountAddress, testNetAccountKey, 1, resourceOnwerAddress, blockingStubFull));
