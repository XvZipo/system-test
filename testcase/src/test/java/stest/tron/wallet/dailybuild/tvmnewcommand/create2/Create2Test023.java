...
public class Create2Test023 {
  ...
  public void test01DeployFactoryContract() {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            user001Address, 10000_000_000L, fromAddress, testKey002, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.freezeBalanceForReceiver(
            fromAddress,
            PublicMethed.getFreezeBalanceCount(
                dev001Address, dev001Key, 170000L * 2, blockingStubFull),
            0,
            1,
  ...
  public void test02TriggerTestContract() {
    ...
    Assert.assertTrue(
        PublicMethed.freezeBalanceForReceiver(
            fromAddress,
            PublicMethed.getFreezeBalanceCount(
                user001Address, user001Key, 50000 * 5L, blockingStubFull),
            0,
            1,
    ...
    triggerTxid =
        PublicMethed.triggerContract(
            ByteArray.fromHexString(exceptedResult),
            "test()",
            "#",
            false,
            callValue,
