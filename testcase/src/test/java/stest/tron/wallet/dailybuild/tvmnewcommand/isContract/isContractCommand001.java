...
public class isContractCommand001 {
  ...
  @Test(
      enabled = true,
      description = "active contract address before deploy contract,then deploy will fail")
  public void test05ActiveContractBeforeDeploy() {
    ...
    Protocol.Transaction transaction =
        PublicMethed.deployContractWithoutBroadcast(
            contractName,
            abi,
            code,
            "",
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            contractAdd, 1L, testNetAccountAddress, testNetAccountKey, blockingStubFull));
    // Code = CONTRACT_VALIDATE_ERROR
    // Message = Contract validate error : Trying to create a contract with existing contract
    // address
  ...
  @Test(
      enabled = true,
      description = "deploy A in create2, A trigger B's iscontract in it's constructor")
  ...
  @Test(
      enabled = true,
      description = "deploy A in create, A trigger B's iscontract in it's constructor")
