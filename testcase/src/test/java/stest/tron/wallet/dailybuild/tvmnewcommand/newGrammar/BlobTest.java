...
public class BlobTest {
  ...
  public void test05KZGPointEvaluation() {
    ...
    String proof =
        "879f9a41956deae578bc65e7133f164394b8677bc2e7b1356be61"
    ...
    GrpcAPI.TransactionExtention transactionExtention =
        PublicMethed.triggerConstantContractForExtention(
            contractC,
            "verifyKZG(bytes,bytes,bytes,bytes,bytes)",
            args,
            false,
            0,
            maxFeeLimit,
  ...
  public void test06KZGPointEvaluation() {
    ...
    String txid =
        PublicMethed.triggerContract(
            contractC,
            "verifyKZG1(bytes,bytes,bytes,bytes,bytes)",
            args,
            false,
            0,
            maxFeeLimit,
  ...
  public void test07callKZGPointEvaluation() {
    ...
    String txid =
        PublicMethed.triggerContract(
            contractC,
            "verifyKZGCall(bytes,bytes,bytes,bytes,bytes)",
            args,
            false,
            0,
            maxFeeLimit,
  ...
  public void test13delegatecallBlobBaseFee() {
    ...
    String txid =
        PublicMethed.triggerContract(
            contractD,
            "delegatecallBlobBaseFee(address)",
            args,
            false,
            0,
            maxFeeLimit,
