...
public class CanCunTest {
  ...
  public void test04TloadTstore() {
    ...
    Assert.assertEquals(
        Protocol.Transaction.Result.contractResult.REVERT, info.getReceipt().getResult());
  }
  ...
  public void test05MemoryCopy() {
    ...
    Assert.assertEquals(
        ...
        ByteArray.toHexString(info.getContractResult(0).toByteArray()));
    Assert.assertEquals(Protocol.TransactionInfo.code.SUCESS, info.getResult());
    Assert.assertEquals(
        Protocol.Transaction.Result.contractResult.SUCCESS, info.getReceipt().getResult());
  }
