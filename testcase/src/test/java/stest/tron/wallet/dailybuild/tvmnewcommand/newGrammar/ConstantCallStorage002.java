...
@Slf4j
public class ConstantCallStorage002 extends AbstractGrpcDualFullAndSolidityTest {
  ...
  @Test(
      enabled = false,
      description =
          "TriggerconstantContract trigger modidy storage date with " + "difference date type")
  public void testConstantCallStorage001() {
    ...
    Assert.assertEquals(
        "SUCESS", transactionExtention.getTransaction().getRet(0).getRet().toString());
    Assert.assertEquals(
        -2, ByteArray.toInt(transactionExtention.getConstantResult(0).toByteArray()));
    ...
    Assert.assertEquals(
        "SUCESS", transactionExtention.getTransaction().getRet(0).getRet().toString());
    Assert.assertEquals(
        "000000000000000000000000dcad3a6d3569df655070ded06cb7a1b2ccd1d3af",
        ByteArray.toHexString(transactionExtention.getConstantResult(0).toByteArray()));
    ...
    Assert.assertEquals(
        "SUCESS", transactionExtention.getTransaction().getRet(0).getRet().toString());
    Assert.assertEquals(
        "dcad3a6d3569df655070ded10000000000000000000000000000000000000000",
        ByteArray.toHexString(transactionExtention.getConstantResult(0).toByteArray()));
    ...
    Assert.assertEquals(
        "SUCESS", transactionExtention.getTransaction().getRet(0).getRet().toString());
    Assert.assertEquals(
        "0000000000000000000000000000000000000000dcad3a6d3569df655070ded0",
        ByteArray.toHexString(transactionExtention.getConstantResult(0).toByteArray()));
    ...
    Assert.assertEquals(
        "321test",
        ByteArray.toStr(
            transactionExtention.getConstantResult(0).substring(64, 64 + 7).toByteArray()));
    ...
    Assert.assertEquals(
        "123qwe",
        ByteArray.toStr(
            transactionExtention.getConstantResult(0).substring(64, 64 + 6).toByteArray()));
    ...
    Assert.assertEquals(
        "SUCESS", transactionExtention.getTransaction().getRet(0).getRet().toString());
    Assert.assertEquals(
        3, ByteArray.toInt(transactionExtention.getConstantResult(0).toByteArray()));
    ...
    Assert.assertEquals(
        "SUCESS", transactionExtention.getTransaction().getRet(0).getRet().toString());
    Assert.assertEquals(
        55, ByteArray.toInt(transactionExtention.getConstantResult(0).toByteArray()));
    ...
    Assert.assertEquals(
        "SUCESS", transactionExtention.getTransaction().getRet(0).getRet().toString());
    Assert.assertEquals(
        34, ByteArray.toInt(transactionExtention.getConstantResult(0).toByteArray()));
  }
