...
public class NewFeatureForSolc0820 {
  ...
  public void beforeClass() {
    ...
    SmartContractOuterClass.SmartContract smartContract =
        PublicMethed.getContract(contract1, blockingStubFull);
  ...
  public void test006EventDefinedOutsideOfContract() throws Exception {
    ...
    Assert.assertEquals(
        topic1,
        "92bbf6e823a631f3c8e09b1c8df90f378fb56f7fbc9701827e1ff8aad7f6a028"); // E() Keccak256
    Assert.assertEquals(
        topic2,
        "70a5d861ef9816388422765f41d618eb3abdf490acb37354b539729e37b09f0e"); // H() Keccak256
