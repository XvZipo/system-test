...
public class NewFeatureForSolc0821 {
  ...
  public void beforeClass() {
    ...
    SmartContractOuterClass.SmartContract smartContract =
        PublicMethed.getContract(contractH, blockingStubFull);
  ...
  public void test002AccessForeignEvent() {
    ...
    Assert.assertEquals(
        transactionExtention.getLogs(0).toString(), transactionExtention.getLogs(1).toString());
    Assert.assertEquals(
        transactionExtention.getLogs(0).toString(), transactionExtention.getLogs(2).toString());
    Assert.assertEquals(
        transactionExtention.getLogs(0).toString(), transactionExtention.getLogs(3).toString());
    Assert.assertEquals(
        "39cf8f4d81ddb7c9a936f0fa76190b3d8084a8c21c154d4b02236a58b3051ad9",
        ByteArray.toHexString(
            transactionExtention.getLogs(1).getData().substring(0, 32).toByteArray()));
    Assert.assertEquals(
        1,
