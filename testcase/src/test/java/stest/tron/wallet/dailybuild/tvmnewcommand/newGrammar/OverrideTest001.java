...
public class OverrideTest001 {
  ...
  public void test01OverrideContract515() {
    ...
    String code = Configuration.getByPath("testng.conf").getString("code.code_override001");
    String abi = Configuration.getByPath("testng.conf").getString("abi.abi_override001");
    ...
    Assert.assertEquals("SUCCESS", transactionExtention.getResult().getCode().toString());
    Assert.assertEquals(
        5, ByteArray.toInt(transactionExtention.getConstantResult(0).toByteArray()));
  }
  ...
  public void test04OverrideModifier060() {
    ...
    Assert.assertEquals("SUCCESS", transactionExtention.getResult().getCode().toString());
    Assert.assertEquals(
        8, ByteArray.toInt(transactionExtention.getConstantResult(0).toByteArray()));
  }

  @Test(enabled = true, description = "Deploy 0.5.15 about override modifier")
  public void test05OverrideModifier515() {
    String contractName = "C";
    String code = Configuration.getByPath("testng.conf").getString("code.code_override002");
    String abi = Configuration.getByPath("testng.conf").getString("abi.abi_override002");
  ...
  public void test07PublicOverrideExternalFunction515() {
    String contractName = "Test";
    String code = Configuration.getByPath("testng.conf").getString("code.code_override003");
    String abi = Configuration.getByPath("testng.conf").getString("abi.abi_override003");
