...
public class UsdtTest001 {
  ...
  String abi = Configuration.getByPath("testng.conf").getString("abi.abi_usdt");
  String code = Configuration.getByPath("testng.conf").getString("code.code_usdt");
  Long energyPrice = 0L;
  ...
  public void beforeClass() {
    ...
    PublicMethed.freezeBalanceForReceiver(
        testNetAccountAddress,
        10000000000L + PublicMethed.randomFreezeAmount.addAndGet(1),
        0,
        1,
    ...
    SmartContract smartContract = PublicMethed.getContract(usdtAddress, blockingStubFull);
    Assert.assertNotNull(smartContract.getAbi());
    logger.info("usdtAddress:" + Base58.encode58Check(usdtAddress));

    energyPrice =
        PublicMethed.getChainParametersValue(
  ...
  public void test01TransferFeeLimitEqualZero() {
    ...
    Assert.assertEquals(
        transaction.getRet(0).getContractRet(),
        Protocol.Transaction.Result.contractResult.OUT_OF_ENERGY);
    Assert.assertEquals(transaction.getRawData().getFeeLimit(), 0L);

    // energy enough but feeLimit = 0
    PublicMethed.sendcoin(
        callerAddress, 2000000000L, testNetAccountAddress, testNetAccountKey, blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    ...
    TransactionInfo transactionInfo2 =
        PublicMethed.getTransactionInfoById(txid2, blockingStubFull).get();
    final Protocol.Transaction transaction2 =
    ...
    Assert.assertEquals(
        transactionInfo2.getReceipt().getResult(),
        Protocol.Transaction.Result.contractResult.OUT_OF_ENERGY);
    Assert.assertEquals(transactionInfo2.getReceipt().getEnergyUsageTotal(), 0L);
    Assert.assertEquals(
        transaction2.getRet(0).getContractRet(),
        Protocol.Transaction.Result.contractResult.OUT_OF_ENERGY);
  ...
  public void test02TransferFeeLimitBoundaryTest() {
    ...
    Assert.assertEquals(
        transaction.getRet(0).getContractRet(), Protocol.Transaction.Result.contractResult.SUCCESS);
    ...
    Assert.assertEquals(
        ...
        Protocol.Transaction.Result.contractResult.SUCCESS);
    Assert.assertEquals(
        transactionInfo2.getReceipt().getEnergyUsage(), exceptEnergyOldAccount.longValue());
    Assert.assertEquals(
        transaction2.getRet(0).getContractRet(),
        Protocol.Transaction.Result.contractResult.SUCCESS);
    Assert.assertEquals(
        transaction2.getRawData().getFeeLimit(), exceptEnergyOldAccount * energyPrice);
  }
  ...
  public void test03TransferWithBlackList() {
    ...
    String txid1 =
        PublicMethed.triggerContract(
            ...
            maxFeeLimit,
            tempKey.getAddress(),
            ByteArray.toHexString(tempKey.getPrivKeyBytes()),
            blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    TransactionInfo transactionInfo =
        PublicMethed.getTransactionInfoById(txid1, blockingStubFull).get();
    Assert.assertEquals(
        transactionInfo.getReceipt().getResult(),
        Protocol.Transaction.Result.contractResult.SUCCESS);
    ...
    TransactionInfo txAddBlackInfo =
        PublicMethed.getTransactionInfoById(txAddBlack, blockingStubFull).get();
    Assert.assertEquals(
        txAddBlackInfo.getReceipt().getResult(),
        Protocol.Transaction.Result.contractResult.SUCCESS);
    Protocol.Transaction txAddBlackTx =
        PublicMethed.getTransactionById(txAddBlack, blockingStubFull).get();
    Assert.assertEquals(
        txAddBlackTx.getRawData().getFeeLimit(), energyPrice * addBlackListEnergyExcept);
    ...
    argsStr =
        "\""
            + Base58.encode58Check(tempKey.getAddress())
            + "\""
            + ",\""
            + Base58.encode58Check(dev001Address)
            + "\",1";
    String txid3 =
        PublicMethed.triggerContract(
            usdtAddress,
            ...
            maxFeeLimit,
            spenderKey.getAddress(),
            ByteArray.toHexString(spenderKey.getPrivKeyBytes()),
            blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    TransactionInfo transactionInfo3 =
        PublicMethed.getTransactionInfoById(txid3, blockingStubFull).get();
    Assert.assertEquals(
        transactionInfo3.getReceipt().getResult(),
        Protocol.Transaction.Result.contractResult.REVERT);
    ...
    TransactionInfo txRemoveBlackListInfo =
        PublicMethed.getTransactionInfoById(txRemoveBlackList, blockingStubFull).get();
    Assert.assertEquals(
        txRemoveBlackListInfo.getReceipt().getResult(),
        Protocol.Transaction.Result.contractResult.SUCCESS);
    Protocol.Transaction txRemoveBlackListTx =
        PublicMethed.getTransactionById(txRemoveBlackList, blockingStubFull).get();
    Assert.assertEquals(
        txRemoveBlackListTx.getRawData().getFeeLimit(), energyPrice * removeEnergyExcept);
    ...
    String txid4 =
        PublicMethed.triggerContract(
            ...
            blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    TransactionInfo transactionInfo4 =
        PublicMethed.getTransactionInfoById(txid4, blockingStubFull).get();
    Assert.assertEquals(
        transactionInfo4.getReceipt().getResult(),
        Protocol.Transaction.Result.contractResult.SUCCESS);
    ...
    TransactionInfo transactionInfo5 =
        PublicMethed.getTransactionInfoById(txid5, blockingStubFull).get();
    Assert.assertEquals(
        transactionInfo5.getReceipt().getResult(),
        Protocol.Transaction.Result.contractResult.SUCCESS);
  }
  ...
  public void test04BlackListFeeLimitEqualZero() {
    ...
    TransactionInfo txAddBlackInfo2 =
        PublicMethed.getTransactionInfoById(txAddBlack2, blockingStubFull).get();
    Assert.assertEquals(
        txAddBlackInfo2.getReceipt().getResult(),
        Protocol.Transaction.Result.contractResult.SUCCESS);
    Protocol.Transaction txAddBlackTx2 =
        PublicMethed.getTransactionById(txAddBlack2, blockingStubFull).get();
    Assert.assertEquals(
        txAddBlackTx2.getRawData().getFeeLimit(), addBlackListEnergyExcept * energyPrice + 1);
    ...
    TransactionInfo txRemoveBlackInfo =
        PublicMethed.getTransactionInfoById(txRemoveBlack, blockingStubFull).get();
    Assert.assertEquals(
        txRemoveBlackInfo.getReceipt().getResult(),
        Protocol.Transaction.Result.contractResult.OUT_OF_ENERGY);
    Protocol.Transaction txRemoveBlackTx =
        PublicMethed.getTransactionById(txRemoveBlack, blockingStubFull).get();
    Assert.assertEquals(txRemoveBlackTx.getRawData().getFeeLimit(), 0L);

    methodStr = "removeBlackList(address)";
    argsStr = "\"" + Base58.encode58Check(tempKey.getAddress()) + "\"";
    String txRemoveBlack2 =
        PublicMethed.triggerContract(
            usdtAddress,
            methodStr,
            argsStr,
    ...
    TransactionInfo txRemoveBlackInfo2 =
        PublicMethed.getTransactionInfoById(txRemoveBlack2, blockingStubFull).get();
    Assert.assertEquals(
        txRemoveBlackInfo2.getReceipt().getResult(),
        Protocol.Transaction.Result.contractResult.SUCCESS);
    Protocol.Transaction txRemoveBlackTx2 =
        PublicMethed.getTransactionById(txRemoveBlack2, blockingStubFull).get();
    Assert.assertEquals(
        txRemoveBlackTx2.getRawData().getFeeLimit(), removeEnergyExcept * energyPrice);
  }
  ...
  public void test05ApproveFeeLimitEqualZero() {
    ...
    String txid2 =
        PublicMethed.triggerContract(
            ...
            false,
            0,
            approveEnergyExcept * energyPrice,
            callerAddress,
            callerKey,
            blockingStubFull);
    PublicMethed.waitProduceNextBlock(blockingStubFull);
  ...
  public void test06ApproveFeeLimitBoundary() {
    ...
    Assert.assertEquals(
        transactionInfo.getReceipt().getResult(),
        Protocol.Transaction.Result.contractResult.OUT_OF_ENERGY);
    Assert.assertEquals(transactionInfo.getReceipt().getEnergyUsageTotal(), 22675L);
    Assert.assertEquals(
        transaction.getRet(0).getContractRet(),
        Protocol.Transaction.Result.contractResult.OUT_OF_ENERGY);
    Assert.assertEquals(
        transaction.getRawData().getFeeLimit(), approveEnergyExcept * energyPrice - 1);
  }

  @Test(enabled = true, description = "add remove when feeLimit = boundary -1")
  public void test07BlackListFeeLimitBoundary() {
    ...
    Protocol.Transaction txAddBlackTx =
        PublicMethed.getTransactionById(txAddBlack, blockingStubFull).get();
    Assert.assertEquals(
        txAddBlackTx.getRawData().getFeeLimit(), addBlackListEnergyExcept * energyPrice - 1);
    ...
    Protocol.Transaction txAddBlackTx2 =
        PublicMethed.getTransactionById(txAddBlack2, blockingStubFull).get();
    Assert.assertEquals(
        txAddBlackTx2.getRawData().getFeeLimit(), addBlackListEnergyExcept * energyPrice);
    ...
    Protocol.Transaction txRemoveBlackTx =
        PublicMethed.getTransactionById(txRemoveBlack, blockingStubFull).get();
    Assert.assertEquals(
        txRemoveBlackTx.getRawData().getFeeLimit(), removeEnergyExcept * energyPrice - 1);
    ...
    Protocol.Transaction txRemoveBlackTx2 =
        PublicMethed.getTransactionById(txRemoveBlack2, blockingStubFull).get();
    Assert.assertEquals(
        txRemoveBlackTx2.getRawData().getFeeLimit(), removeEnergyExcept * energyPrice + 1);
  }
  ...
  public void shutdown() throws InterruptedException {
    ...
    PublicMethed.unDelegateResourceV2(
        testNetAccountAddress, 8000000000L, 1, dev001Address, testNetAccountKey, blockingStubFull);
    PublicMethed.unDelegateResourceV2(
        testNetAccountAddress, 300000000L, 0, callerAddress, testNetAccountKey, blockingStubFull);
