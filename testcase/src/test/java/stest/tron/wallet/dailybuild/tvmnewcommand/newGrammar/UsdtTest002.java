...
public class UsdtTest002 {
  ...
  public void test01() {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            callerddress, 1000000000L, testNetAccountAddress, testNetAccountKey, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    ...
    Assert.assertEquals(
        energyFee * infoById.get().getReceipt().getEnergyUsageTotal(),
    ...
    Assert.assertTrue(
        infoById.get().getResMessage().toStringUtf8().contains("Not enough energy for"));
  ...
  public void test02() {
    Assert.assertTrue(
        PublicMethed.freezeBalanceV2(dev001Address, 100000000L, 0, dev001Key, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    long balance = PublicMethed.queryAccount(dev001Address, blockingStubFull).getBalance();
    long needSend = balance - rightFeeLimit;
    Assert.assertTrue(
        PublicMethed.sendcoin(callerddress, needSend, dev001Address, dev001Key, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    ...
    Assert.assertEquals(
        energyFee * infoById.getReceipt().getEnergyUsageTotal(),
        infoById.getReceipt().getEnergyFee());
  ...
  public void test03() {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            dev001Address, needSend, testNetAccountAddress, testNetAccountKey, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
  ...
  public void test04() {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            dev001Address, 200000000L, testNetAccountAddress, testNetAccountKey, blockingStubFull));
    Assert.assertTrue(
        PublicMethed.freezeBalanceV2(dev001Address, 50000000L, 1, dev001Key, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    ...
    Assert.assertEquals(
        Math.round(energyUsageTotal * (100 - consumeUserResourcePercent) / 100), originEnergyUsage);
    Assert.assertEquals(389, netUsage);
  ...
  public void test05() {
    ...
    Assert.assertTrue(
        PublicMethed.updateSetting(
            usdtAddress, consumeUserResourcePercent, dev001Key, dev001Address, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    long temPercent =
        PublicMethed.getContract(usdtAddress, blockingStubFull).getConsumeUserResourcePercent();
