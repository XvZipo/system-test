...
public class VirtualTest001 {
  ...
  public void test01OverrideContract515() {
    ...
    String code = Configuration.getByPath("testng.conf").getString("code.code_virtual001");
    String abi = Configuration.getByPath("testng.conf").getString("abi.abi_virtual001");
