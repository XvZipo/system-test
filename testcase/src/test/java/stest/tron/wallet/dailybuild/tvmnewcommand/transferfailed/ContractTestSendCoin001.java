...
public class ContractTestSendCoin001 {
  ...
  @Test(
      enabled = true,
      description = "Sendcoin and transferAsset to contractAddresss ," + "then selfdestruct")
  public void testSendCoinAndTransferAssetContract001() {
    ...
    Assert.assertTrue(
        PublicMethed.freezeBalanceForReceiver(
            fromAddress,
            PublicMethed.getFreezeBalanceCount(dev001Address, dev001Key, 130000L, blockingStubFull),
            0,
            1,
    ...
    final String deployContractTxid =
    ...
    Optional<TransactionInfo> infoById =
        PublicMethed.getTransactionInfoById(deployContractTxid, blockingStubFull);
    ...
    Return ret =
        PublicMethed.transferAssetForReturn(
    ...
    Assert.assertEquals(
        "Contract validate error : Cannot transfer asset to smartContract.",
    ...
    Return ret1 =
        PublicMethed.sendcoinForReturn(
            transferTokenContractAddress, 1_000_000L, fromAddress, testKey002, blockingStubFull);
  ...
  @Test(
      enabled = true,
      description =
          "Use create to generate a contract address "
  ...
  public void testSendCoinAndTransferAssetContract002() {
    ...
    Assert.assertEquals(
        ...
        ret.getMessage().toStringUtf8());
    Long contractAssetCount =
        PublicMethed.getAssetIssueValue(testContractAddress, assetAccountId, blockingStubFull);
    logger.info(
        "Contract has AssetId: "
            + assetAccountId.toStringUtf8()
            + ", Count: "
    ...
    Return ret1 =
        PublicMethed.sendcoinForReturn(
            testContractAddress, 1_000_000L, fromAddress, testKey002, blockingStubFull);
    Assert.assertEquals(CONTRACT_VALIDATE_ERROR, ret1.getCode());
    Assert.assertEquals(
        "Contract validate error : Cannot transfer TRX to a smartContract.",
        ret1.getMessage().toStringUtf8());
    ...
    long contractAssetCountBefore =
        PublicMethed.getAssetIssueValue(testContractAddress, assetAccountId, blockingStubFull);
    long contractBefore =
        PublicMethed.queryAccount(testContractAddress, blockingStubFull).getBalance();
  ...
  @Test(
      enabled = true,
      description =
          "Use create2 to generate a contract address "
              + "Sendcoin and transferAsset to contractAddresss ,then selfdestruct")
  public void testSendCoinAndTransferAssetContract003() {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            contractExcAddress, 2000000000L, fromAddress, testKey002, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    ...
    if (PublicMethed.allowTvmSelfdestructRestrictionIsActive(blockingStubFull)) {
      ...
      Assert.assertFalse(
          PublicMethed.sendcoin(
              returnAddressBytes, 1_000_000L, fromAddress, testKey002, blockingStubFull));
      txid =
          PublicMethed.triggerContract(
              contractAddress,
              "deploy(bytes,uint256)",
      ...
      Assert.assertTrue(
          transactionExtention
              ...
              .getCode()
              .toString()
              .contains("CONTRACT_VALIDATE_ERROR"));
      Assert.assertTrue(
          transactionExtention
              .getResult()
              .getMessage()
