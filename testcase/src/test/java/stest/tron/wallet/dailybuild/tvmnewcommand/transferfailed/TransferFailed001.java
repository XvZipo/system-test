...
@Slf4j
public class TransferFailed001 extends AbstractGrpcDualFullAndSolidityTest {
  ...
  public void test001TransferTrxInsufficientBalance() {
    ...
    txid =
        PublicMethed.triggerContract(
            contractAddress,
            "testTransferTrxInsufficientBalance(uint256)",
            num,
            false,
            0,
            maxFeeLimit,
  ...
  public void test003TransferTrxNonexistentTarget() {
    ...
    txid =
        PublicMethed.triggerContract(
            contractAddress,
            "testTransferTrxNonexistentTarget(uint256,address)",
            num,
            false,
            0,
            maxFeeLimit,
    ...
    Account nonexistentAddressAccount =
        PublicMethed.queryAccount(nonexistentAddress, blockingStubFull1);
    ...
    Assert.assertEquals(energyUsageTotal2 + EnergyCost.getNewAcctCall(), energyUsageTotal);
  }
  ...
  @Test(
      enabled = true,
      description =
          "PreCompiled transfertoken with value," + " long.max < value or long.min > value")
  public void test007TransferTrckenPreCompiled() {
    ...
    txid =
        PublicMethed.triggerContract(
            contractAddress,
            "testTransferTokenCompiledLongMax1()",
            "#",
            false,
            0,
            maxFeeLimit,
    ...
    resourceInfo = PublicMethed.getAccountResource(contractExcAddress, blockingStubFull);
    info = PublicMethed.queryAccount(contractExcKey, blockingStubFull);
    ...
    txid =
        PublicMethed.triggerContract(
            contractAddress,
            "testTransferTokenCompiledLongMin1()",
            "#",
            false,
            0,
            maxFeeLimit,
  ...
  public void test008TransferTrctoken() {
    ...
    txid =
        PublicMethed.triggerContract(
            contractAddress,
            "testTransferTokenTest(address,uint256)",
            num,
            false,
            0,
            maxFeeLimit,
  ...
  public void test009TransferTrctoken() {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            addressxx, 1000000L, testNetAccountAddress, testNetAccountKey, blockingStubFull));
    ...
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Long returnAddressBytesAccountCountBefore =
        PublicMethed.getAssetIssueValue(addressxx, assetAccountId, blockingStubFull);
    logger.info("returnAddressBytesAccountCountBefore : " + returnAddressBytesAccountCountBefore);
    Account info;
    ...
    txid =
        PublicMethed.triggerContract(
            contractAddress,
            "testTransferTokenCompiledTokenId(uint256)",
            num,
            false,
            0,
            maxFeeLimit,
  ...
  public void test010TransferRevert() {
    ...
    txid =
        PublicMethed.triggerContract(
            contractAddress,
            "testTransferTrxrevert(uint256,address)",
            num,
            false,
            0,
            maxFeeLimit,
