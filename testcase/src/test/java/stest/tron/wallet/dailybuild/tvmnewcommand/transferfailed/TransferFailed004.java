...
public class TransferFailed004 {
  ...
  public void test1SuicideNonexistentTarget() {
    ...
    contractAddress =
        PublicMethed.deployContractFallbackReceive(
            contractName,
            abi,
            code,
            "",
    ...
    String assetIssueId =
        PublicMethed.queryAccount(contractAddress, blockingStubFull)
            .getAssetIssuedID()
            .toStringUtf8();
    logger.info("assetIssueId: " + assetIssueId);
    Assert.assertEquals(0, assetIssueId.length());

    Account nonexistentAddressAccountTrxBalance =
    ...
    Long nonexistentAddressAccountTokenBalance =
  ...
  public void test3SuicideNonexistentTargetRevert() {
    ...
    Account nonexistentAddressAccount =
        PublicMethed.queryAccount(nonexistentAddress1, blockingStubFull1);
  ...
  public void test4transferToSuicideContractSameToken() {
    ...
    if (PublicMethed.allowTvmSelfdestructRestrictionIsActive(blockingStubFull)) {
      ...
      Account nonexistentAddressAccount =
          PublicMethed.queryAccount(contractAddress, blockingStubFull1);
  ...
  public void test5transferToSuicideContractDifferentToken() {
    ...
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    assetAccountId2 =
        PublicMethed.queryAccount(contractExcAddress3, blockingStubFull).getAssetIssuedID();
    ...
    Account info;
    AccountResourceMessage resourceInfo =
        PublicMethed.getAccountResource(contractExcAddress3, blockingStubFull);
    ...
    if (PublicMethed.allowTvmSelfdestructRestrictionIsActive(blockingStubFull)) {
      ...
      Long contractAccountCountTokenBalance =
          PublicMethed.getAssetIssueValue(contractAddress, assetAccountId, blockingStubFull);
      Assert.assertEquals(0L, contractAccountCountTokenBalance.longValue());
      Long contractAccountCountTokenBalance2 =
          PublicMethed.getAssetIssueValue(contractAddress, assetAccountId2, blockingStubFull);
