...
@Slf4j
public class TriggerConstant016 extends AbstractGrpcDualFullAndSolidityTest {
  ...
  @Test(
      enabled = false,
      description = "TriggerConstantContract a non-constant function " + "created by create2")
