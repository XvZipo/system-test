...
@Slf4j
public class TriggerConstant022 extends AbstractGrpcDualFullAndSolidityTest {
  ...
  @Test(
      enabled = false,
      description = "TriggerContract a non-payable function " + "with ABI(constant ABI)")
  public void testTriggerContract() {
    ...
    String abi =
        "[{\"constant\":true,\"inputs\":[],\"name\":\"testNoPayable\",\"outputs\":[{\""
