...
public class FreezeContractTest001 {
  ...
  void FreezeContractTest001() {
    ...
    AccountResourceMessage account002_before =
        PublicMethed.getAccountResource(testAddress002, blockingStubFull);
    ...
    AccountResourceMessage account002_after =
        PublicMethed.getAccountResource(testAddress002, blockingStubFull);
    ...
    Assert.assertEquals(
        contractAccount_before.getAccountResource().getDelegatedFrozenBalanceForEnergy()
            + freezeCount,
        contractAccount_after.getAccountResource().getDelegatedFrozenBalanceForEnergy());
    Assert.assertEquals(
        contractAccount_before.getBalance() - freezeCount, contractAccount_after.getBalance());
  ...
  void FreezeContractTest002() {
    AccountResourceMessage contractResource_before =
    ...
    AccountResourceMessage contractResource_after =
        PublicMethed.getAccountResource(contractAddress, blockingStubFull);
    Account contractAccount_after = PublicMethed.queryAccount(contractAddress, blockingStubFull);
    ...
    Assert.assertEquals(
        contractAccount_before.getAccountResource().getFrozenBalanceForEnergy().getFrozenBalance()
            + freezeCount,
  ...
  void FreezeContractTest003() {
    ...
    AccountResourceMessage contractResource_after =
        PublicMethed.getAccountResource(newContract, blockingStubFull);
    Account contractAccount_after = PublicMethed.queryAccount(contractAddress, blockingStubFull);
  ...
  @Test(
      description = "contract freeze to unactive account",
  ...
  void FreezeContractTest004() {
    ...
    AccountResourceMessage account002_after =
        PublicMethed.getAccountResource(testAddress, blockingStubFull);
    Account contractAccount_after = PublicMethed.queryAccount(contractAddress, blockingStubFull);
  ...
  @Test(
      description = "contract freeze to pre create2 address, and UnFreeze",
      dependsOnMethods = "FreezeContractTest001")
  void FreezeContractTest005() {
    ...
    String addressHex =
        "41" + ByteArray.toHexString(exten.getConstantResult(0).toByteArray()).substring(24);
    ...
    AccountResourceMessage account002_after =
        PublicMethed.getAccountResource(create2Address, blockingStubFull);
    Account contractAccount_after = PublicMethed.queryAccount(contractAddress, blockingStubFull);
  ...
  @Test(description = "Unfreeze when freeze to account", dependsOnMethods = "FreezeContractTest001")
  ...
  @Test(
      description = "Unfreeze when freeze to contract self",
  ...
  public void freezeEnergyCaulate() {
    ...
    TransactionInfo info = PublicMethed.getTransactionInfoById(txid, blockingStubFull).get();
    AccountResourceMessage testAccount001 =
  ...
  @Test(
      description = "Get Zero Address ExpireTime,used to be that freeze to contract self",
      dependsOnMethods = "FreezeContractTest002")
  ...
  public void FreezeContractTest006() {
    ...
    AccountResourceMessage account003_before =
        PublicMethed.getAccountResource(testAddress003, blockingStubFull);
    ...
    AccountResourceMessage account003_after =
        PublicMethed.getAccountResource(testAddress003, blockingStubFull);
    Account contractAccount_after = PublicMethed.queryAccount(contractAddress, blockingStubFull);
    ...
    Assert.assertEquals(
        callValue, contractAccount_after.getAccountResource().getDelegatedFrozenBalanceForEnergy());
