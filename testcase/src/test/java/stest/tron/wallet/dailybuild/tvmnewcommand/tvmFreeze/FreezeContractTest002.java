...
public class FreezeContractTest002 {
  ...
  void FreezeContract002() {
    ...
    Account account002_before = PublicMethed.queryAccount(testAddress002, blockingStubFull);
    Account contractAccount_before = PublicMethed.queryAccount(contractAddress, blockingStubFull);
    ...
    Account account002_after = PublicMethed.queryAccount(testAddress002, blockingStubFull);
    Account contractAccount_after = PublicMethed.queryAccount(contractAddress, blockingStubFull);
  ...
  void FreezeContract004() {
    ...
    Assert.assertEquals(
        contractAccount_before.getDelegatedFrozenBalanceForBandwidth() + freezeCount,
