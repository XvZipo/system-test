...
public class ContractRewardTest001 {
  ...
  void rewardbalanceTest001() {
    BytesMessage bytesMessage =
        BytesMessage.newBuilder()
            .setValue(ByteString.copyFrom(PublicMethed.getFinalAddress(witnessKey)))
            .build();
  ...
  @Test(
      enabled = false,
      description = "querry contract account,reward should equal to " + "gerRewardInfo")
  void rewardbalanceTest004() {
    BytesMessage bytesMessage =
        BytesMessage.newBuilder().setValue(ByteString.copyFrom(contractAddress)).build();
    long reward = blockingStubFull.getRewardInfo(bytesMessage).getNum();
  ...
  void rewardbalanceTest005() {
    BytesMessage bytesMessage =
        BytesMessage.newBuilder()
            .setValue(ByteString.copyFrom(PublicMethed.getFinalAddress(testFoundationKey)))
            .build();
    long reward = blockingStubFull.getRewardInfo(bytesMessage).getNum();
