  ...
  public void test4InjectExchange() {
    ...
    while (times++ <= 10000) {
      ...
      HttpMethed.exchangeInject(
          httpnode, exchangeOwnerAddress, exchangeId, assetIssueId1, 10L, exchangeOwnerKey);
      ...
      HttpMethed.exchangeTransaction(
          httpnode, exchangeOwnerAddress, exchangeId, assetIssueId2, 100L, 1L, exchangeOwnerKey);
      HttpMethed.transferAsset(
          httpnode, asset2Address, exchangeOwnerAddress, assetIssueId2, 1L, asset2Key);
      HttpMethed.transferAsset(
          httpnode, exchangeOwnerAddress, asset2Address, assetIssueId1, 1L, exchangeOwnerKey);
      HttpMethed.participateAssetIssue(
          httpnode, exchangeOwnerAddress, asset2Address, assetIssueId1, 1L, asset2Key);
      HttpMethed.participateAssetIssue(
          httpnode, asset2Address, exchangeOwnerAddress, assetIssueId2, 1L, exchangeOwnerKey);
      HttpMethed.freezeBalance(
          httpnode, fromAddress, 10000000000L, 0, 0, exchangeOwnerAddress, testKey002);
      HttpMethed.freezeBalance(
          httpnode, fromAddress, 10000000000L, 0, 1, exchangeOwnerAddress, testKey002);
      HttpMethed.unFreezeBalance(
          httpnode, fromAddress, 10000000000L, 0, exchangeOwnerAddress, testKey002);
      HttpMethed.unFreezeBalance(
          httpnode, fromAddress, 10000000000L, 1, exchangeOwnerAddress, testKey002);
    }
  }
