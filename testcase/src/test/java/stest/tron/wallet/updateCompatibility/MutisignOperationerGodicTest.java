...
public class MutisignOperationerGodicTest {
  ...
  public void beforeSuite() {
    ...
    if (PublicMethed.queryAccount(foundationZenTokenKey, blockingStubFull).getCreateTime() == 0) {
      PublicMethed.sendcoin(
          foundationZenTokenAddress, 20480000000000L, fromAddress, testKey002, blockingStubFull);
  ...
  public void beforeClass() {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            mutisignAccountAddress, 1000_000_000_000L, fromAddress, testKey002, blockingStubFull));
  ...
  public void test001MutiSignGodicAccountTypeTransaction() {
    Assert.assertTrue(
        PublicMethedForMutiSign.setAccountId1(
            ...
            permissionKeyString));
    Assert.assertTrue(
        PublicMethedForMutiSign.createAccountWhtiPermissionId(
            mutisignAccountAddress,
            newAddress,
            mutisignAccountKey,
            blockingStubFull,
            ...
            permissionKeyString));
    Assert.assertTrue(
        PublicMethedForMutiSign.sendcoinWithPermissionId(
            newAddress,
            100L,
            mutisignAccountAddress,
            2,
            ...
            permissionKeyString));
    Assert.assertTrue(
        PublicMethedForMutiSign.freezeBalanceWithPermissionId(
            mutisignAccountAddress,
            1000000L,
            0,
            2,
            ...
            permissionKeyString));
    Assert.assertTrue(
        PublicMethedForMutiSign.freezeBalanceGetEnergyWithPermissionId(
            mutisignAccountAddress,
            1000000L,
            0,
            1,
            ...
            permissionKeyString));
    Assert.assertTrue(
        PublicMethedForMutiSign.freezeBalanceForReceiverWithPermissionId(
            mutisignAccountAddress,
            1000000L,
            0,
            0,
            ...
            permissionKeyString));
    Assert.assertTrue(
        PublicMethedForMutiSign.unFreezeBalanceWithPermissionId(
            mutisignAccountAddress,
            mutisignAccountKey,
            0,
            null,
    ...
    Assert.assertTrue(
        PublicMethedForMutiSign.unFreezeBalanceWithPermissionId(
            ...
            permissionKeyString));
    Assert.assertTrue(
        PublicMethedForMutiSign.updateAccountWithPermissionId(
            mutisignAccountAddress,
            updateName.getBytes(),
            mutisignAccountKey,
            blockingStubFull,
  ...
  public void test002MutiSignGodicContractTypeTransaction() {
    ...
    byte[] contractAddress =
        PublicMethedForMutiSign.deployContractWithPermissionId(
            contractName,
            abi,
            code,
            "",
    ...
    txid =
        PublicMethedForMutiSign.triggerContractWithPermissionId(
            contractAddress,
            "testUseCpu(uint256)",
            initParmes,
            false,
    ...
    Assert.assertTrue(
        PublicMethedForMutiSign.clearContractAbi(
            contractAddress,
            mutisignAccountAddress,
            mutisignAccountKey,
            blockingStubFull,
  ...
  public void test003MutiSignGodicTokenTypeTransaction() {
    ...
    Assert.assertTrue(
        PublicMethedForMutiSign.createAssetIssueWithpermissionId(
            mutisignAccountAddress,
            name,
            totalSupply,
            1,
    ...
    getAssetIdFromOwnerAccount =
        PublicMethed.queryAccount(mutisignAccountAddress, blockingStubFull);
    assetAccountId1 = getAssetIdFromOwnerAccount.getAssetIssuedID();

    Assert.assertTrue(
        PublicMethedForMutiSign.transferAssetWithpermissionId(
            manager1Address,
    ...
    Assert.assertTrue(
        PublicMethedForMutiSign.updateAssetWithPermissionId(
            mutisignAccountAddress,
  ...
  public void test004MutiSignGodicExchangeTypeTransaction() {
    ...
    org.junit.Assert.assertTrue(
        PublicMethed.sendcoin(
            secondExchange001Address, 10240000000L, fromAddress, testKey002, blockingStubFull));
    org.junit.Assert.assertTrue(
    ...
    getAssetIdFromThisAccount =
        PublicMethed.queryAccount(secondExchange001Address, blockingStubFull);
    ...
    org.junit.Assert.assertTrue(
        PublicMethedForMutiSign.exchangeTransaction1(
            exchangeId,
            assetAccountId1.toByteArray(),
            50,
            1,
    ...
    Assert.assertTrue(
        PublicMethedForMutiSign.participateAssetIssueWithPermissionId(
            secondExchange001Address,
            assetAccountId2.toByteArray(),
            1,
            mutisignAccountAddress,
  ...
  public void test005MutiSignGodicShieldTransaction() {
    ...
    final Long beforeAssetBalance =
        PublicMethed.getAssetIssueValue(
            ...
            blockingStubFull);
    final Long beforeBalance =
        PublicMethed.queryAccount(mutisignAccountAddress, blockingStubFull).getBalance();
    final Long beforeNetUsed =
        PublicMethed.getAccountResource(mutisignAccountAddress, blockingStubFull).getFreeNetUsed();

    String memo = "aaaaaaa";

    shieldOutList =
        PublicMethed.addShieldOutputList(
            shieldOutList, shieldAddress, "" + (sendTokenAmount - zenTokenFee), memo);

    Assert.assertTrue(
        PublicMethedForMutiSign.sendShieldCoin(
            mutisignAccountAddress,
            sendTokenAmount,
            null,
            null,
  ...
  public void test006MutiSignGodicWitnessTransaction() {
    ...
    Assert.assertTrue(
        PublicMethed.sendcoin(
            newAddress, 1000000_000_000L, fromAddress, testKey002, blockingStubFull));
    logger.info(accountPermissionJson);
    Assert.assertTrue(
        PublicMethedForMutiSign.accountPermissionUpdate(
            accountPermissionJson, newAddress, newKey, blockingStubFull, new String[] {newKey}));
    PublicMethed.waitProduceNextBlock(blockingStubFull);

    long now = System.currentTimeMillis();
    String url = "MutiSign001_" + Long.toString(now) + ".com";
    Assert.assertTrue(
        PublicMethedForMutiSign.createWitness(
            url, newAddress, newKey, 2, permissionKeyString, blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    Assert.assertTrue(
        PublicMethedForMutiSign.updateWitness2(
            newAddress,
            "newWitness.com".getBytes(),
            newKey,
            2,
            permissionKeyString,
            blockingStubFull));
    ...
    Assert.assertTrue(
        PublicMethedForMutiSign.voteWitnessWithPermissionId(
            smallVoteMap,
            mutisignAccountAddress,
            mutisignAccountKey,
            blockingStubFull,
  ...
  public void test007MutiSignGodicProposalTypeTransaction() {
    ...
    Assert.assertTrue(
        PublicMethedForMutiSign.createProposalWithPermissionId(
            newAddress, newKey, proposalMap, 2, blockingStubFull, permissionKeyString));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    // Get proposal list
    ...
    Assert.assertTrue(
        PublicMethedForMutiSign.approveProposalWithPermission(
            newAddress, newKey, proposalId, true, 2, blockingStubFull, permissionKeyString));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    // Delete proposal list after approve
    Assert.assertTrue(
        PublicMethedForMutiSign.deleteProposalWithPermissionId(
  ...
  public void test008MutiSignGodicWithdrawBanlanceTransaction() {
    ...
    Assert.assertTrue(
        PublicMethedForMutiSign.withdrawBalance(
            newAddress, newKey, 2, permissionKeyString, blockingStubFull));
  }
